...
$connect = mysqli_connect("localhost", "yook6442", "yug6442!", "yook6442") or die("fail");
  ...
  $sql = "insert into hogi01_mix values
	('$product','$date','$checktime_1','$writer','$pl100e_a_1','$pl100e_a_2','$pl100e_c_1','$pl100e_c_2','$pr_1','$pr_2','$sk_8000m_1','$sk_8000m_2','$sk_8000m_3','$sk_8000m_4','$cm_1','$cm_2','$cm_3','$cm_4','$sk_8000l_1','$sk_8000l_2','$sk_8000l_3','$sk_8000l_4',
	 '$sk_8000s_1','$sk_8000s_2','$sk_8000s_3','$sk_8000s_4','$sk_3000nv_1','$sk_3000nv_2','$sk_3000nv_3','$sk_3000nv_4','$sk_3100n_1','$sk_3100n_2','$sk_3100n_3','$sk_3100n_4','$we_8000_1','$we_8000_2','$we_8000_3','$we_8000_4','$mbs_1','$mbs_2','$mbs_3','$mbs_4',
	 '$pa910_1','$pa910_2','$pa910_3','$pa910_4','$d2t_1','$d2t_2','$d2t_3','$d2t_4','$jd_1','$jd_2','$jd_3','$jd_4','$sn1_1','$sn1_2','$sn1_3','$sn1_4','$sn2_1','$sn2_2','$sn2_3','$sn2_4','$yc34_1','$yc34_2','$yc34_3','$yc34_4','$nt3_1','$nt3_2','$nt3_3','$nt3_4',
	 '$pl100n_1','$pl100n_2','$pl100n_3','$pl100n_4','$mi_1','$mi_2','$mi_3','$mi_4','$ls130_1','$ls130_2','$ls130_3','$ls130_4','$onemix_1','$onemix_2','$mixcount_1','$mixcount_2','$mixtime_1','$mixtime_2','$mixdegree_1','$mixdegree_2')";
