...
<head>
  ...
  $(document).ready(function(){
     <?php
         ...
         $rows_1_6 = array();
         while($row_1_6=mysqli_fetch_array($result1_6)) {
           $rows_1_6[] = $row_1_6;
         };
         $rows_2_6 = array();
         while($row_2_6=mysqli_fetch_array($result2_6)) {
           $rows_2_6[] = $row_2_6;
         };
  ...
  <script>
      ...
      foreach($rows_1_6 as $value1_6) {
        ?>
        myArray1_1[i] = "<?=$value1_6['num']?>";
        myArray1_2[i] = "<?=$value1_6['product']?>";
        myArray1_3[i] = "<?=$value1_6['date']?>";
        myArray1_4[i] = "<?=$value1_6['writer']?>";
        myArray1_5[i] = "<?=$value1_6['input_time']?>";
        myArray1_6[i] = "<?=$value1_6['c1']?>";
        myArray1_7[i] = "<?=$value1_6['c2']?>";
        myArray1_8[i] = "<?=$value1_6['c3']?>";
        myArray1_9[i] = "<?=$value1_6['c4']?>";
        myArray1_10[i] = "<?=$value1_6['nop_1']?>";
        myArray1_11[i] = "<?=$value1_6['d1']?>";
        myArray1_12[i] = "<?=$value1_6['d2']?>";
        myArray1_13[i] = "<?=$value1_6['d3']?>";
        myArray1_14[i] = "<?=$value1_6['d4']?>";
        myArray1_15[i] = "<?=$value1_6['nop_2']?>";
        myArray1_16[i] = "<?=$value1_6['screwrpm']?>";
        myArray1_17[i] = "<?=$value1_6['screwap']?>";
        myArray1_18[i] = "<?=$value1_6['hdmoterrpm']?>";
        myArray1_19[i] = "<?=$value1_6['hdmoterap']?>";
        myArray1_20[i] = "<?=$value1_6['suzitem']?>";
        myArray1_21[i] = "<?=$value1_6['suzipre']?>";
        myArray1_22[i] = "<?=$value1_6['jingon']?>";
        myArray1_23[i] = "<?=$value1_6['jingonsu']?>";
        myArray1_24[i] = "<?=$value1_6['icetem']?>";
        myArray1_25[i] = "<?=$value1_6['inche']?>";
        myArray1_26[i] = "<?=$value1_6['length']?>";
   ...
   <script>
        ...
        <?php
        foreach($rows_2_6 as $value2_6) {
          ?>
          myArray2_1[i2] = "<?=$value2_6['product']?>";
          myArray2_2[i2] = "<?=$value2_6['date']?>";
          myArray2_3[i2] = "<?=$value2_6['writer']?>";
          myArray2_4[i2] = "<?=$value2_6['input_time']?>";
          myArray2_5[i2] = "<?=$value2_6['appearance']?>";
          myArray2_6[i2] = "<?=$value2_6['color']?>";
          myArray2_7[i2] = "<?=$value2_6['out_min']?>";
          myArray2_8[i2] = "<?=$value2_6['out_max']?>";
          myArray2_9[i2] = "<?=$value2_6['diameter']?>";
          myArray2_10[i2] = "<?=$value2_6['thick_min']?>";
          myArray2_11[i2] = "<?=$value2_6['thick_max']?>";
          myArray2_12[i2] = "<?=$value2_6['length']?>";
          myArray2_13[i2] = "<?=$value2_6['ps']?>";
          myArray2_14[i2] = "<?=$value2_6['weight']?>";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">6호기 데이터베이스</li>
        </ol>
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-danger mb-3 h-100">
              <div class="card-header">당일 6호기 압출 데이터 수</div>
                <div class="card-body text-danger">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">6호기 압출의 데이터 수</h5>
                  <div class="mr-5"><?=$row11_6?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-warning mb-3 h-100">
              <div class="card-header">당일 6호기 절단 데이터 수</div>
                <div class="card-body text-warning">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">6호기 절단의 데이터 수</h5>
                  <div class="mr-5"><?=$row12_6?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-success mb-3 h-100">
              <div class="card-header">당일 6호기 수량 데이터 수</div>
                <div class="card-body text-success">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">6호기 수량의 데이터 수</h5>
                  <div class="mr-5"><?= $row13_6?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-info mb-3 success h-100">
              <div class="card-header">당일 6호기 배합 데이터 수</div>
                <div class="card-body text-info">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title"> 6호기 배합의 데이터 수</h5>
                  <div class="mr-5"><?= $row15_6?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-primary mb-3 h-100">
              <div class="card-header">당일 6호기 기타 데이터 수</div>
                <div class="card-body text-primary">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">6호기 기타의 데이터 수</h5>
                  <div class="mr-5"><?= $row14_6?> 개</div>
                </div>
            </div>
          </div>
