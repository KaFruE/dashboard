  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-primary float-right clocks" href="input_expand_process1_work.php">야간</a>
          <a id="clock2" class="btn btn-primary float-right clocks" href="input_expand_process1_work.php">주간</a>
        </ol>

      </br></br>
      <form method='post' action='write_expand_process1_work.php'>
