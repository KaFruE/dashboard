...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_1_press_hivp";
            // where date='$date'";
        ...
        document.getElementById('m_H_2').value= "<?= $row['m_H_2']?>";
        ...
        document.getElementById('m_inmoter').value= "<?= $row['m_inmoter']?>";
        document.getElementById('m_inscrew').value= "<?= $row['m_inscrew']?>";
  ...
  <script type="text/javascript">
      function actdb()
      {
        document.getElementById('m_H').disabled = false;
        ...
        document.getElementById('m_c1_1').disabled = false;
        document.getElementById('m_c2_1').disabled = false;
        document.getElementById('m_c3_1').disabled = false;
        document.getElementById('m_c4_1').disabled = false;
        document.getElementById('m_c5_1').disabled = false;
        document.getElementById('m_H_1').disabled = false;
        document.getElementById('m_H_2').disabled = false;
        document.getElementById('m_corex').disabled = false;
        ...
        document.getElementById('m_inheater').disabled = false;
        ...
        document.getElementById('m_inmoter').disabled = false;
        document.getElementById('m_inscrew').disabled = false;
        document.getElementById('m_jingon_1').disabled = false;
        document.getElementById('m_icetem').disabled = false;
        document.getElementById('m_inche').disabled = false;
      }
      ...
      function revisedb()
      {
            ...
            var m19 = $('#m_d5').val();
            var m20 = $('#m_d6').val();
            var m21 = $('#m_inheater').val();
            var m22 = $('#m_hdmoter').val();
            var m23 = $('#m_screw').val();
            var m24 = $('#m_jingon').val();
            var m25 = $('#m_inmoter').val();
            var m26 = $('#m_inscrew').val();
            var m27 = $('#m_jingon_1').val();
            var m28 = $('#m_icetem').val();
            var m29 = $('#m_inche').val();


            window.location.href = './input_process1_press_hivp.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m14='+m14+'&m15='+m15+
            ...
            <?php
              ...
              $sql = "update management_1_press_hivp set
              m_H='$m1',m_c1='$m2',m_c2='$m3',m_c3='$m4',m_c4='$m5',m_c5='$m6',m_c1_1='$m7',m_c2_1='$m8',m_c3_1='$m9',m_c4_1='$m10',m_c5_1='$m11',m_H_1='$m12',m_H_2='$m13',m_corex='$m14',m_d1='$m15',m_d2='$m16',m_d3='$m17',m_d4='$m18',m_d5='$m19',m_d6='$m20',m_inheater='$m21',m_hdmoter='$m22',m_screw='$m23',m_jingon='$m24',m_inmoter='$m25',m_inscrew='$m26',m_jingon_1='$m27',m_icetem='$m28',m_inche='$m29'
               where m_product='1'";
              if($m1){
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="input_process1_press">압출</a>
          </li>
        ...
        <ol class="bread">
          <a class="btn btn-outline-secondary" href="input_process1_press_hivg.php">HIVG</a>
          <a class="btn btn-outline-secondary" href="input_process1_press_hivp.php">HIVP</a>
        </ol>
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process1_press_hivp.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process1_press_hivp.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process1_press_hivp.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process1_press_hivp.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process1_press_hivp.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="H" id="H" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th>C1</th>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="c1_1" id="c1_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >C2</th>
                  <th><input type="text" name="m_c2_1" id="m_c2_1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="c2_1" id="c2_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >C3</th>
                  <th><input type="text" name="m_c3_1" id="m_c3_1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="c3_1" id="c3_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >C4</th>
                  <th><input type="text" name="m_c4_1" id="m_c4_1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="c4_1" id="c4_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >C5</th>
                  <th><input type="text" name="m_c5_1" id="m_c5_1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="c5_1" id="c5_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >H</th>
                  <th><input type="text" name="m_H_1" id="m_H_1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="H_1" id="H_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th rowspan="8"=>다이스온도</th>
                  <th >H</th>
                  <th><input type="text" name="m_H_2" id="m_H_2" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="H_2" id="H_2" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >코렉스</th>
                  <th><input type="text" name="m_corex" id="m_corex" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="corex" id="corex" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >D1</th>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="inheater" id="inheater" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  <th colspan="2"=>내피 휘드모터 RPM</th>
                  <th><input type="text" name="m_inmoter" id="m_inmoter" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="inmoter" id="inmoter" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>내피 스크류 RPM</th>
                  <th><input type="text" name="m_inscrew" id="m_inscrew" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="inscrew" id="inscrew" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>진공계</th>
                  <th><input type="text" name="m_jingon_1" id="m_jingon_1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="jingon_1" id="jingon_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="inche" id="inche" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th>절단</th>
                  <th colspan="3">길이(6235~6245 mm)</th>
