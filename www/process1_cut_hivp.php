...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_1_cut_hivp where m_product='1'";
            // where date='$date'";
        ...
        document.getElementById('m_diameter_min').value= "<?= $row['m_diameter_min']?>";
        document.getElementById('m_diameter_max').value= "<?= $row['m_diameter_max']?>";
        document.getElementById('m_diameter_avg').value= "<?= $row['m_diameter_avg']?>";
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1 = "select * from hogi01_cut_hivp where date='$dt' AND INput_time BETWEEN'06:00:01' AND '12:00:00'";
        $query2 = "select * from hogi01_cut_hivp where date='$dt' AND INput_time BETWEEN'12:00:01' AND '18:00:00'";
        $query3 = "select * from hogi01_cut_hivp where date='$dt' AND INput_time BETWEEN'18:00:01' AND '23:59:59'";
        $query4 = "select * from hogi01_cut_hivp where date='$dt' AND INput_time BETWEEN'00:00:00' AND '06:00:00'";
    ...
    document.getElementById('diameter_min_4').value= "<?= $row4['diameter_min']?>";
    document.getElementById('diameter_max_4').value= "<?= $row4['diameter_max']?>";
    document.getElementById('diameter_avg_4').value= "<?= $row4['diameter_avg']?>";
    ...
    document.getElementById('diameter_min_1').value= "<?= $row1['diameter_min']?>";
    document.getElementById('diameter_max_1').value= "<?= $row1['diameter_max']?>";
    document.getElementById('diameter_avg_1').value= "<?= $row1['diameter_avg']?>";
    ...
    document.getElementById('diameter_min_2').value= "<?= $row2['diameter_min']?>";
    document.getElementById('diameter_max_2').value= "<?= $row2['diameter_max']?>";
    document.getElementById('diameter_avg_2').value= "<?= $row2['diameter_avg']?>";
    ...
    document.getElementById('diameter_min_3').value= "<?= $row3['diameter_min']?>";
    document.getElementById('diameter_max_3').value= "<?= $row3['diameter_max']?>";
    document.getElementById('diameter_avg_3').value= "<?= $row3['diameter_avg']?>";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process1_cut_hivp.php?date=' + value;
  ...
  <script type="text/javascript">
    ...
    function revisedb(){
      ...
      document.getElementById('diameter_min_1').disabled = false;
      document.getElementById('diameter_max_1').disabled = false;
      document.getElementById('diameter_avg_1').disabled = false;
      ...
      document.getElementById('diameter_min_2').disabled = false;
      document.getElementById('diameter_max_2').disabled = false;
      document.getElementById('diameter_avg_2').disabled = false;
      ...
      document.getElementById('diameter_min_3').disabled = false;
      document.getElementById('diameter_max_3').disabled = false;
      document.getElementById('diameter_avg_3').disabled = false;
      ...
      document.getElementById('diameter_min_4').disabled = false;
      document.getElementById('diameter_max_4').disabled = false;
      document.getElementById('diameter_avg_4').disabled = false;
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">HIVP</li>
        </ol>
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process1_cut_hivp.php'>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    <th colspan="3">겉모양 및 모양</th>
                    <td colspan="1"><input type="text" name="appearance_1" id="appearance_1" class="form-control"disabled='disabled'  placeholder="양호" /></td>
                    <td colspan="1"><input type="text" name="appearance_2" id="appearance_2" class="form-control"disabled='disabled'  placeholder="양호" /></td>
                    <td colspan="1"><input type="text" name="appearance_3" id="appearance_3" class="form-control"disabled='disabled'  placeholder="양호" /></td>
                    <td colspan="1"><input type="text" name="appearance_4" id="appearance_4" class="form-control"disabled='disabled'  placeholder="양호" /></td>
                  </tr>
                  <tr>
                    <th colspan="3">관의 색</th>
                    <td colspan="1"><input type="text" name="color_1" id="color_1" class="form-control"disabled='disabled'  placeholder="색" /></td>
                    <td colspan="1"><input type="text" name="color_2" id="color_2" class="form-control"disabled='disabled'  placeholder="색" /></td>
                    <td colspan="1"><input type="text" name="color_3" id="color_3" class="form-control"disabled='disabled'  placeholder="색" /></td>
                    <td colspan="1"><input type="text" name="color_4" id="color_4" class="form-control"disabled='disabled'  placeholder="색" /></td>
                  </tr>
                  <tr>
                    <th rowspan="3">바깥지름(mm) </th>
                    <th>최소</th>
                    <th> <input type="text" name="m_diameter_min" id="m_diameter_min" disabled='disabled' class="form-control"/>이상</th>
                    <td colspan="1"><input type="number" name="diameter_min_1" id="diameter_min_1" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                    <td colspan="1"><input type="number" name="diameter_min_2" id="diameter_min_2" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                    <td colspan="1"><input type="number" name="diameter_min_3" id="diameter_min_3" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                    <td colspan="1"><input type="number" name="diameter_min_4" id="diameter_min_4" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>

                  </tr>
                  <tr>
                   <th>최대</th>
                   <th> <input type="text" name="m_diameter_max" id="m_diameter_max" disabled='disabled' class="form-control"/>이하</th>
                   <td colspan="1"><input type="number" name="diameter_max_1" id="diameter_max_1" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                   <td colspan="1"><input type="number" name="diameter_max_2" id="diameter_max_2" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                   <td colspan="1"><input type="number" name="diameter_max_3" id="diameter_max_3" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                   <td colspan="1"><input type="number" name="diameter_max_4" id="diameter_max_4" disabled='disabled' class="form-control"step='0.01' placeholder="바깥지름" /></td>
                  </tr>
                  <tr>
                   <th>평균</th>
                   <th> <input type="text" name="m_diameter_avg" id="m_diameter_avg" disabled='disabled' class="form-control"/></th>
                   <td colspan="1"><input type="number" name="diameter_avg_1" id="diameter_avg_1"disabled='disabled'  class="form-control"step='0.01' placeholder="바깥지름" /></td>
                   <td colspan="1"><input type="number" name="diameter_avg_2" id="diameter_avg_2"disabled='disabled'  class="form-control"step='0.01' placeholder="바깥지름" /></td>
                   <td colspan="1"><input type="number" name="diameter_avg_3" id="diameter_avg_3"disabled='disabled'  class="form-control"step='0.01' placeholder="바깥지름" /></td>
                   <td colspan="1"><input type="number" name="diameter_avg_4" id="diameter_avg_4"disabled='disabled'  class="form-control"step='0.01' placeholder="바깥지름" /></td>
                  </tr>
                  <tr>
                    <th rowspan="2">두께(mm)</th>
                    <th>최소</th>
                    <th> <input type="text" name="m_thick_min" id="m_thick_min" disabled='disabled' class="form-control"/>이상</th>
                    <td ><input type="number" name="thick_min_1" id="thick_min_1" class="form-control"step='0.01' disabled='disabled' placeholder="최소" /></td>
                    <td ><input type="number" name="thick_min_2" id="thick_min_2" class="form-control"step='0.01' disabled='disabled' placeholder="최소" /></td>
                    <td ><input type="number" name="thick_min_3" id="thick_min_3" class="form-control"step='0.01' disabled='disabled' placeholder="최소" /></td>
                    <td ><input type="number" name="thick_min_4" id="thick_min_4" class="form-control"step='0.01' disabled='disabled' placeholder="최소" /></td>
                  </tr>
                  <tr>

                    <th>최대</th>
                    <th> <input type="text" name="m_thick_max" id="m_thick_max" disabled='disabled' class="form-control"/>이하 </th>
                    <td ><input type="number" name="thick_max_1" id="thick_max_1" class="form-control"step='0.01'disabled='disabled'  placeholder="최대" /></td>
                    <td ><input type="number" name="thick_max_2" id="thick_max_2" class="form-control"step='0.01'disabled='disabled'  placeholder="최대" /></td>
                    <td ><input type="number" name="thick_max_3" id="thick_max_3" class="form-control"step='0.01'disabled='disabled'  placeholder="최대" /></td>
                    <td ><input type="number" name="thick_max_4" id="thick_max_4" class="form-control"step='0.01'disabled='disabled'  placeholder="최대" /></td>
                  </tr>
                  <tr>
                    <th  colspan="2">직관부길이(mm)</th>
                    <th> <input type="text" name="m_length" id="m_length" disabled='disabled' class="form-control"/></th>
                    <td><input type="number" name="length_1" id="length_1" class="form-control"step='0.01' disabled='disabled' placeholder="길이" /></td>
                    <td><input type="number" name="length_2" id="length_2" class="form-control"step='0.01' disabled='disabled' placeholder="길이" /></td>
                    <td><input type="number" name="length_3" id="length_3" class="form-control"step='0.01' disabled='disabled' placeholder="길이" /></td>
                    <td><input type="number" name="length_4" id="length_4" class="form-control"step='0.01' disabled='disabled' placeholder="길이" /></td>
                  </tr>
                  <tr>
                    <th  colspan="2">표시사항</th>
                    <th>규정된 표시사항</th>
                    <td><input type="text" name="ps_1" id="ps_1" class="form-control"disabled='disabled' placeholder="표시사항" /></td>
                    <td><input type="text" name="ps_2" id="ps_2" class="form-control"disabled='disabled' placeholder="표시사항" /></td>
                    <td><input type="text" name="ps_3" id="ps_3" class="form-control"disabled='disabled' placeholder="표시사항" /></td>
                    <td><input type="text" name="ps_4" id="ps_4" class="form-control" disabled='disabled'placeholder="표시사항" /></td>
                  </tr>
                  <tr>
                    <th colspan="2">중량(kg)</th>
                    <th> <input type="text" name="m_weight" id="m_weight" disabled='disabled' class="form-control"/></th>
                    <td><input type="number" name="weight_1" id="weight_1" class="form-control"step='0.01'disabled='disabled'  placeholder="kg" /></td>
                    <td><input type="number" name="weight_2" id="weight_2" class="form-control"step='0.01'disabled='disabled'  placeholder="kg" /></td>
                    <td><input type="number" name="weight_3" id="weight_3" class="form-control"step='0.01'disabled='disabled'  placeholder="kg" /></td>
                    <td><input type="number" name="weight_4" id="weight_4" class="form-control"step='0.01'disabled='disabled'  placeholder="kg" /></td>
                  </tr>
