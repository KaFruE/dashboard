...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from hogi03_mix where date='$dt' AND checktime_1 BETWEEN'06:00:01' AND '18:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process3_mix_1.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process3_mix.php'>
