...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_3_press";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        ...
        document.getElementById('m_c7').disabled = false;
        document.getElementById('m_c8').disabled = false;
        ...
        document.getElementById('m_mainmoter').disabled = false;
        document.getElementById('m_mainrpm').disabled = false;
      ...
      function revisedb()
      {
            ...
            var m18=$('#m_hdmoter').val();
            var m19=$('#m_mainmoter').val();
            var m20=$('#m_mainrpm').val();
            var m21=$('#m_screw').val();
            var m22=$('#m_icetem').val();
            var m23=$('#m_corogate').val();

            window.location.href = './input_process3_press.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m14='+m14+'&m15='+m15+
            ...
            <?php
              ...
              $sql = "update management_3_press set
              m_c1='$m1',m_c2='$m2',m_c3='$m3',m_c4='$m4',m_c5='$m5',m_c6='$m6',m_c7='$m7',m_c8='$m8',m_H='$m9',m_d1='$m10',m_d3='$m11',m_d4='$m12',m_d5='$m13',m_d6='$m14',m_nop='$m15',m_jm='$m16',m_jingon='$m17',m_hdmoter='$m18',m_mainmoter='$m19',m_mainrpm='$m20',m_screw='$m21',m_icetem='$m22',m_corogate='$m23'
               where m_product='1'";
              if($m1){
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="input_process3.php">제 3 호기</a>
          </li>
          <li class="breadcrumb-item active">압출</li>
        </ol>

        <ol class="bread">
          <a class="btn btn-outline-secondary" href="input_process3_mix.php">배합</a>
          <a class="btn btn-outline-secondary" href="input_process3_press.php">압출</a>
          <a class="btn btn-outline-secondary" href="input_process3_cut.php">검사</a>
          <a class="btn btn-outline-secondary" href="input_process3_count.php">수량</a>
          <a class="btn btn-outline-secondary" href="input_process3_other.php">기타</a>
        </ol>
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process3_press.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process3_press.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process3_press.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process3_press.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process3_press.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="c7" id="c7" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th>C8</th>
                  <th><input type="text" name="m_c8" id="m_c8" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="c8" id="c8" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th>H</th>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="mainmoter" id="mainmoter" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>메인모타 RPM</th>
                  <th><input type="text" name="m_mainrpm" id="m_mainrpm" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="mainrpm" id="mainrpm" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
