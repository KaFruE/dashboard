  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process1_count.php">야간</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process1_count.php">주간</a>
        </ol>
      ...
      <form method='post' action='write_process1_count.php'>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tr>
                  <td colspan="2"><input type="text" name="standard_1" id="standard_1" class="form-control" placeholder="규격" value="HIVP 250 x 6250" /></td>
                ...
                <tr>
                  <td colspan="2"><input type="text" name="standard_2" id="standard_2" class="form-control" placeholder="규격"value="HIVP 250 x 6070" /></td>
                ...
                <tr>
                  <td colspan="2"><input type="text" name="standard_3" id="standard_3" class="form-control" placeholder="규격"value="HIVP 250 x 6750" /></td>
