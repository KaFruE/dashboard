...
$connect = mysqli_connect("localhost", "yook6442", "yug6442!", "yook6442") or die("fail");
  ...
  writer ='$writer_1',input_time='$input_time_1',appearance='$appearance_1',color='$color_1',diameter='$diameter_1',out_max='$out_max_1',
	out_min='$out_min_1',in_max='$in_max_1',in_min='$in_min_1',gol_max='$gol_max_1',gol_min='$gol_min_1',
	display='$display_1',length='$length_1'where date='$date' AND INput_time='$input_time_1'";

	$sql2 = "update hogi04_cut set
	product = '$product',date = '$date',
  writer ='$writer_2',input_time='$input_time_2',appearance='$appearance_2',color='$color_2',diameter='$diameter_2',out_max='$out_max_2',
	out_min='$out_min_2',in_max='$in_max_2',in_min='$in_min_2',gol_max='$gol_max_2',gol_min='$gol_min_2',
	display='$display_2',length='$length_2'where date='$date' AND INput_time='$input_time_2'";

	$sql3 = "update hogi04_cut set
	product = '$product',date = '$date',
  writer ='$writer_3',input_time='$input_time_3',appearance='$appearance_3',color='$color_3',diameter='$diameter_3',out_max='$out_max_3',
	out_min='$out_min_3',in_max='$in_max_3',in_min='$in_min_3',gol_max='$gol_max_3',gol_min='$gol_min_3',
	display='$display_3',length='$length_3'where date='$date' AND INput_time='$input_time_3'";

	$sql4 = "update hogi04_cut set
	product = '$product',date = '$date',
	writer ='$writer_4',input_time='$input_time_4',appearance='$appearance_4',color='$color_4',diameter='$diameter_4',out_max='$out_max_4',
	out_min='$out_min_4',in_max='$in_max_4',in_min='$in_min_4',gol_max='$gol_max_4',gol_min='$gol_min_4',
	display='$display_4',length='$length_4'where date='$date' AND INput_time='$input_time_4'";
