...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        if($worktime_1 <=0)
        {
          $worktime_1 = $worktime_1 + 1440;
        }
        if($worktime_2 <=0)
        {
          $worktime_2 = $worktime_2 + 1440;
        }
        if($worktime_3 <=0)
        {
          $worktime_3 = $worktime_3 + 1440;
        }
        if($worktime_4 <=0)
        {
          $worktime_4 = $worktime_4 + 1440;
        }
        if($worktime_5 <=0)
        {
          $worktime_5 = $worktime_5 + 1440;
        }
        if($worktime_6 <=0)
        {
          $worktime_6 = $worktime_6 + 1440;
        }
        if($worktime_7 <=0)
        {
          $worktime_7 = $worktime_7 + 1440;
        }
        ...
        if($worktime_1_b <=0)
        {
          $worktime_1_b = $worktime_1_b + 1440;
        }
        if($worktime_2_b <=0)
        {
          $worktime_2_b = $worktime_2_b + 1440;
        }
        if($worktime_3_b <=0)
        {
          $worktime_3_b = $worktime_3_b + 1440;
        }
        if($worktime_4_b <=0)
        {
          $worktime_4_b = $worktime_4_b + 1440;
        }
        if($worktime_5_b <=0)
        {
          $worktime_5_b = $worktime_5_b + 1440;
        }
        if($worktime_6_b <=0)
        {
          $worktime_6_b = $worktime_6_b + 1440;
        }
        if($worktime_7_b <=0)
        {
          $worktime_7_b = $worktime_7_b + 1440;
        }
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="process5.php">제 5 호기</a>
          </li>
          <li class="breadcrumb-item active">수량</li>
        </ol>

        <ol class="bread">
          <a class="btn btn-outline-secondary" href="process5_mix.php">배합</a>
          <a class="btn btn-outline-secondary" href="process5_press.php">압출</a>
          <a class="btn btn-outline-secondary" href="process5_cut.php">검사</a>
          <a class="btn btn-outline-secondary" href="process5_count.php">수량</a>
          <a class="btn btn-outline-secondary" href="process5_other.php">기타</a>
        </ol>

        <ol class="bread">
          <a class="btn btn-outline-danger" href="process5_count_n.php">주간</a>
          <a class="btn btn-outline-primary" href="process5_count_b.php">야간</a>
