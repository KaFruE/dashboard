...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_2_cut where m_product='1'";
            // where date='$date'";
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1 = "select * from hogi02_cut where date='$dt' AND INput_time BETWEEN'06:00:01' AND '12:00:00'";
        $query2 = "select * from hogi02_cut where date='$dt' AND INput_time BETWEEN'12:00:01' AND '18:00:00'";
        $query3 = "select * from hogi02_cut where date='$dt' AND INput_time BETWEEN'18:00:01' AND '23:59:59'";
        $query4 = "select * from hogi02_cut where date='$dt' AND INput_time BETWEEN'00:00:00' AND '06:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process2_cut.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process2_cut.php'>
