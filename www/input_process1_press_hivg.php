...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_1_press_hivg";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        ...
        document.getElementById('m_c6').disabled = false;
        ...
        document.getElementById('m_middlemoter').disabled = false;
        document.getElementById('m_middlescrew').disabled = false;
      ...
      function revisedb()
      {
            ...
            var m18 = $('#m_d4').val();
            var m19 = $('#m_d5').val();
            var m20 = $('#m_inheater').val();
            var m21 = $('#m_hdmoter').val();
            var m22 = $('#m_screw').val();
            var m23 = $('#m_jingon').val();
            var m24 = $('#m_middlemoter').val();
            var m25 = $('#m_middlescrew').val();
            var m26 = $('#m_jingon_1').val();
            var m27 = $('#m_icetem').val();
            var m28 = $('#m_inche').val();


            window.location.href = './input_process1_press_hivg.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m14='+m14+'&m15='+m15+
            '&m16='+m16+'&m17='+m17+'&m18='+m18+'&m19='+m19+'&m20='+m20+'&m21='+m21+'&m22='+m22+'&m23='+m23+'&m24='+m24+'&m25='+m25+'&m26='+m26+'&m27='+m27+'&m28='+m28;
            ...
            <?php
              ...
              $sql = "update management_1_press_hivg set
              m_c1='$m1',m_c2='$m2',m_c3='$m3',m_c4='$m4',m_c5='$m5',m_c6='$m6',m_c1_1='$m7',m_c2_1='$m8',m_c3_1='$m9',m_c4_1='$m10',m_c5_1='$m11',m_H='$m12',m_H_1='$m13',m_corex='$m14',m_d1='$m15',m_d2='$m16',m_d3='$m17',m_d4='$m18',m_d5='$m19',m_inheater='$m20',m_hdmoter='$m21',m_screw='$m22',m_jingon='$m23',m_middlemoter='$m24',m_middlescrew='$m25',m_jingon_1='$m26',m_icetem='$m27',m_inche='$m28'
               where m_product='1'";
              if($m1){
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process1_press_hivg.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process1_press_hivg.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process1_press_hivg.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process1_press_hivg.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process1_press_hivg.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="c6" id="c6" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="middlemoter" id="middlemoter" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>중간 스크류 RPM</th>
                  <th><input type="text" name="m_middlescrew" id="m_middlescrew" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="middlescrew" id="middlescrew" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>진공계</th>
