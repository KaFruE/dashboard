      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="input_process5.php">제 5 호기</a>
          </li>
          <li class="breadcrumb-item active">기타</li>
        </ol>

        <ol class="bread">
          <a class="btn btn-outline-secondary" href="input_process5_mix.php">배합</a>
          <a class="btn btn-outline-secondary" href="input_process5_press.php">압출</a>
          <a class="btn btn-outline-secondary" href="input_process5_cut.php">검사</a>
          <a class="btn btn-outline-secondary" href="input_process5_count.php">수량</a>
          <a class="btn btn-outline-secondary" href="input_process5_other.php">기타</a>
        </ol>



      <form method='post' action='write_process5_other.php'>
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead>
              <tr>
                <th>작업시간(시작)</th>
                <td><input type="time" name="workinghours_1" id="workinghours_1" class="form-control" placeholder="시 간" /></td>
                <th>작업시간(종료)</th>
                <td><input type="time" name="workinghours_2" id="workinghours_2" class="form-control" placeholder="시 간" /></td>
                <th>잠깐정지시간</th>
                <td><input type="number" name="awhilestop_1" id="awhilestop_1" class="form-control" placeholder="분" /></td>
                <th>잠깐정지시간</th>
                <td><input type="number" name="awhilestop_2" id="awhilestop_2" class="form-control" placeholder="분" /></td>
              </tr>
            </thead>
          </table>
        </div>
        ...
        <tbody>
          ...
          <tr>
            <th>제동시간</th>
            <td><input type="time" name="checktime_5" id="checktime_5" class="form-control" placeholder="체크시간" /></td>
          </tr>
        </tbody>
        </table>
        </div>
        ...
        <tbody>
          ...
          <tr>
            <th>예열</th>
            <td><input type="time" name="checktime_6" id="checktime_6" class="form-control" placeholder="체크시간" /></td>
          </tr>
          <tr>
            <th>조정</th>
            <td><input type="time" name="checktime_7" id="checktime_7" class="form-control" placeholder="체크시간" /></td>
          </tr>
          <tr>
            <th>가동</th>
            <td><input type="time" name="checktime_8" id="checktime_8" class="form-control" placeholder="체크시간" /></td>
          </tr>
          <tr>
            <th>조정시간</th>
            <td><input type="time" name="checktime_9" id="checktime_9" class="form-control" placeholder="체크시간" /></td>
          </tr>
          <tr>
            <th>제동시간</th>
            <td><input type="time" name="checktime_10" id="checktime_10" class="form-control" placeholder="체크시간" /></td>
          </tr>
          </tbody>
         </table>
        </div>
