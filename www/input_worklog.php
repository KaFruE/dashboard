...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.php">NUVOTEC Dashboard</a>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">작업 일지</li>
        </ol>
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              <tr>
                <th>공장(PVC)</th>
                <th class="table-under-small">1</th>
                ...
                <td><input type="number" class="form-control" placeholder="본당 중량" /></td>
                <td><input type="number" class="form-control" placeholder="중량(kg)" /></td>
                <td><input type="number" class="form-control" placeholder="작업 시간(분)" /></td>
                <td><input type="number" class="form-control" placeholder="시간(분)" /></td>
                <td><input type="text" class="form-control" placeholder="기호" /></td>
                <td><input type="number" class="form-control" placeholder="중량" /></td>
                <td><input type="text" class="form-control" placeholder="기호" /></td>
                <td colspan="2"><input type="text" class="form-control" placeholder="비고" /></td>
              </tr>
            </tbody>
          </table>
        </div>
