...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_7_press";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        ...
        document.getElementById('m_nop').disabled = false;
        document.getElementById('m_d35').disabled = false;
        document.getElementById('m_head').disabled = false;
        document.getElementById('m_cart1').disabled = false;
        document.getElementById('m_cart2').disabled = false;
        document.getElementById('m_jm').disabled = false;
        document.getElementById('m_maintalk').disabled = false;
        document.getElementById('m_screw').disabled = false;
        document.getElementById('m_hdtalk').disabled = false;
        document.getElementById('m_hoper').disabled = false;
        document.getElementById('m_suzitem').disabled = false;
        document.getElementById('m_apjingon').disabled = false;
        document.getElementById('m_air').disabled = false;
        document.getElementById('m_icepress').disabled = false;
      ...
      function revisedb()
      {
            ...
            var m16 = $('#m_cart2').val();
            var m17 = $('#m_jm').val();
            var m18 = $('#m_maintalk').val();
            var m19 = $('#m_screw').val();
            var m20 = $('#m_hdtalk').val();
            var m21 = $('#m_hoper').val();
            var m22 = $('#m_suzitem').val();
            var m23 = $('#m_apjingon').val();
            var m24 = $('#m_air').val();
            var m25 = $('#m_icepress').val();
            var m26 = $('#m_icetem').val();
            var m27 = $('#m_up').val();
            var m28 = $('#m_down').val();
            var m29 = $('#m_in').val();
            var m30 = $('#m_out').val();
            ...
            window.location.href = './input_process7_press.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m14='+m14+'&m15='+m15+
            ...
            <?php
              ...
              $sql = "update management_7_press set
              m_c1='$m1',m_c2='$m2',m_c3='$m3',m_c4='$m4',m_c5='$m5',m_c6='$m6',m_d1='$m7',m_d2='$m8',m_d3='$m9',m_d4='$m10',m_d5='$m11',m_nop='$m12',m_d35='$m13',m_head='$m14',m_cart1='$m15',m_cart2='$m16',m_jm='$m17',m_maintalk='$m18',m_screw='$m19',m_hdtalk='$m20',m_hoper='$m21',m_suzitem='$m22',m_apjingon='$m23',m_air='$m24',m_icepress='$m25',m_icetem='$m26',m_up='$m27',m_down='$m28',m_in='$m29',m_out='$m30',m_rpm='$m31'
               where m_product='1'";
              if($m1){
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process7_press.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process7_press.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process7_press.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process7_press.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process7_press.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="nop" id="nop" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th >D35</th>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="head" id="head" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">카트리지 1</th>
                  <th><input type="text" name="m_cart1" id="m_cart1" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="cart1" id="cart1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">카트리지2</th>
                  <th><input type="text" name="m_cart2" id="m_cart2" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="cart2" id="cart2" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">주물</th>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="maintalk" id="maintalk" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="hdtalk" id="hdtalk" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">호퍼 RPM</th>
                  <th><input type="text" name="m_hoper" id="m_hoper" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="hoper" id="hoper" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">수지온도</th>
                  <th><input type="text" name="m_suzitem" id="m_suzitem" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="suzitem" id="suzitem" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">압출기 진공</th>
                  <th><input type="text" name="m_apjingon" id="m_apjingon" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="apjingon" id="apjingon" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th>AIR</th>
                  <th>P</th>
                  <th><input type="text" name="m_air" id="m_air" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="air" id="air" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">냉각수압력(압출기)</th>
                  <th><input type="text" name="m_icepress" id="m_icepress" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="icepress" id="icepress" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="in" id="in" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th>OUT</th>
                  <th><input type="text" name="m_out" id="m_out" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="out" id="out" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2">RPM</th>
