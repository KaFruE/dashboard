...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_2_press where m_product='1'";
            // where date='$date'";
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1 = "select * from hogi02_press where date='$dt' AND INput_time BETWEEN'06:00:01' AND '12:00:00'";
        $query2 = "select * from hogi02_press where date='$dt' AND INput_time BETWEEN'12:00:01' AND '18:00:00'";
        $query3 = "select * from hogi02_press where date='$dt' AND INput_time BETWEEN'18:00:01' AND '23:59:59'";
        $query4 = "select * from hogi02_press where date='$dt' AND INput_time BETWEEN'00:00:00' AND '06:00:00'";
    ...
    document.getElementById('writer_3').value = "<?= $row4['writer']?>";
    ...
    document.getElementById('tolk_4').value= "<?= $row4['tolk']?>";
    ...
    document.getElementById('tolk_1').value= "<?= $row1['tolk']?>";
    ...
    document.getElementById('writer_1').value = "<?= $row2['writer']?>";
    ...
    document.getElementById('tolk_2').value= "<?= $row2['tolk']?>";
    ...
    document.getElementById('tolk_3').value= "<?= $row3['tolk']?>";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process2_press.php?date=' + value;
  ...
  <script type="text/javascript">
    ...
    function revisedb(){
      ...
      document.getElementById('tolk_1').disabled = false;
      ...
      document.getElementById('tolk_2').disabled = false;
      ...
      document.getElementById('tolk_3').disabled = false;
      ...
      document.getElementById('tolk_4').disabled = false;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process2_press.php'>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input type="number" name='tolk_1' id='tolk_1' class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name='tolk_2' id='tolk_2' class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name='tolk_3' id='tolk_3' class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name='tolk_4' id='tolk_4' class="form-control" disabled='disabled' placeholder="온도" /></td>
                  </tr>
                  <tr>
