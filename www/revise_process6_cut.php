<?php
	...
	header("Content-Type:text/html;charset=utf-8");
	  ...
	  $sql1 = "update hogi06_cut set
		product = '$product',date = '$date',writer='$writer_1',input_time='$input_time_1',appearance='$appearance_1',color='$color_1',out_min='$out_min_1',out_max='$out_max_1',diameter='$diameter_1',thick_min='$thick_min_1',thick_max='$thick_max_1',length='$length_1',
		ps='$ps_1',weight='$weight_1' where date='$date' AND INput_time='$input_time_1'";

	  $sql2 = "update hogi06_cut set
	  product = '$product',date = '$date',writer='$writer_1',input_time='$input_time_2',appearance='$appearance_2',color='$color_2',out_min='$out_min_2',out_max='$out_max_2',diameter='$diameter_2',thick_min='$thick_min_2',thick_max='$thick_max_2',length='$length_2',
		ps='$ps_2',weight='$weight_2' where date='$date' AND INput_time='$input_time_2'";

	  $sql3 = "update hogi06_cut set
	  product = '$product',date = '$date',writer='$writer_3',input_time='$input_time_3',appearance='$appearance_3',color='$color_3',out_min='$out_min_3',out_max='$out_max_3',diameter='$diameter_3',thick_min='$thick_min_3',thick_max='$thick_max_3',length='$length_3',
		ps='$ps_3',weight='$weight_3' where date='$date' AND INput_time='$input_time_3'";

	  $sql4 = "update hogi06_cut set
	  product = '$product',date = '$date',writer='$writer_3',input_time='$input_time_4',appearance='$appearance_4',color='$color_4',out_min='$out_min_4',out_max='$out_max_4',diameter='$diameter_4',thick_min='$thick_min_4',thick_max='$thick_max_4',length='$length_4',
