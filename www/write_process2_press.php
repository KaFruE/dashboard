...
$connect = mysqli_connect("localhost", "yook6442", "yug6442!", "yook6442") or die("fail");
  ...
  $sql = "insert into hogi02_press values
	('$num','$product','$date','$writer','$input_time','$c1','$c2','$c3','$c4','$c5','$c6','$c7','$c8','$H','$d1','$d2','$d3','$d4','$d5','$d6','$d7','$d8','$jm','$jingon','$hdmoter','$screw','$tolk','$icetem','$corogate','$tube','$length')";
