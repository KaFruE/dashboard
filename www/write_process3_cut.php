...
$length = $_POST['length'];
  ...
  $sql = "insert into hogi03_cut values
	('$product','$date','$writer','$input_time','$appearance','$color','$diameter','$out_max','$out_min','$in_max','$in_min','$gol_max','$gol_min','$display','$length')";
