...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_6_cut where m_product='1'";
            // where date='$date'";
        ...
        document.getElementById('m_out_min').value= "<?= $row['m_out_min']?>";
        document.getElementById('m_out_max').value= "<?= $row['m_out_max']?>";
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1 = "select * from hogi06_cut where date='$dt' AND INput_time BETWEEN'06:00:01' AND '12:00:00'";
        $query2 = "select * from hogi06_cut where date='$dt' AND INput_time BETWEEN'12:00:01' AND '18:00:00'";
        $query3 = "select * from hogi06_cut where date='$dt' AND INput_time BETWEEN'18:00:01' AND '23:59:59'";
        $query4 = "select * from hogi06_cut where date='$dt' AND INput_time BETWEEN'00:00:00' AND '06:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process6_cut.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process6_cut.php'>
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    <th rowspan="2">평균바깥지름(mm)</th>
                    <th>최소</th>
                    <th><input type="text" name="m_out_min" id="m_out_min" disabled='disabled' class="form-control"/>mm이상</th>
                    <td colspan="2"><input type="number" name="out_min_1" id="out_min_1" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                    <td colspan="2"><input type="number" name="out_min_2" id="out_min_2" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                    <td colspan="2"><input type="number" name="out_min_3" id="out_min_3" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                    <td colspan="2"><input type="number" name="out_min_4" id="out_min_4" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                  </tr>
                  <tr>
                    <th>최대 </th>
                    <th><input type="text" name="m_out_max" id="m_out_max" disabled='disabled' class="form-control"/>mm이하</th>
                    <td colspan="2"><input type="number" name="out_max_1" id="out_max_1" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                    <td colspan="2"><input type="number" name="out_max_2" id="out_max_2" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                    <td colspan="2"><input type="number" name="out_max_3" id="out_max_3" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                    <td colspan="2"><input type="number" name="out_max_4" id="out_max_4" disabled='disabled' class="form-control" placeholder="바깥지름" /></td>
                  </tr>
                  <tr>
                    <th colspan="2">평균 바깥지름 </th>
                    <th><input type="text" name="m_diameter" id="m_diameter" disabled='disabled' class="form-control"/> mm</th>
                    <td colspan="2"><input type="number" name="diameter_1" id="diameter_1" disabled='disabled' class="form-control" placeholder="평균바깥지름" /></td>
                    <td colspan="2"><input type="number" name="diameter_2" id="diameter_2" disabled='disabled' class="form-control" placeholder="평균바깥지름" /></td>
                    <td colspan="2"><input type="number" name="diameter_3" id="diameter_3" disabled='disabled' class="form-control" placeholder="평균바깥지름" /></td>
                    <td colspan="2"><input type="number" name="diameter_4" id="diameter_4" disabled='disabled' class="form-control" placeholder="평균바깥지름" /></td>
                  </tr>
                  <tr>
                    <th rowspan="2">두께(mm)</th>
                    <th>최소</th>
                    <th><input type="text" name="m_thick_min" id="m_thick_min" disabled='disabled' class="form-control"/>mm이상</th>
                    <td colspan="2"><input type="number" name="thick_min_1" id="thick_min_1"disabled='disabled' class="form-control"placeholder="두께" /></td>
                    <td colspan="2"><input type="number" name="thick_min_2" id="thick_min_2"disabled='disabled' class="form-control"placeholder="두께" /></td>
                    <td colspan="2"><input type="number" name="thick_min_3" id="thick_min_3"disabled='disabled' class="form-control"placeholder="두께" /></td>
                    <td colspan="2"><input type="number" name="thick_min_4" id="thick_min_4"disabled='disabled' class="form-control"placeholder="두께" /></td>
                  </tr>
                  <tr>
                    <th>최대</th>
                    <th><input type="text" name="m_thick_max" id="m_thick_max" disabled='disabled' class="form-control"/>mm이하</th>
                    <td colspan="2"><input type="number" name="thick_max_1" id="thick_max_1" disabled='disabled'class="form-control" placeholder="두께" /></td>
                    <td colspan="2"><input type="number" name="thick_max_2" id="thick_max_2" disabled='disabled'class="form-control" placeholder="두께" /></td>
                    <td colspan="2"><input type="number" name="thick_max_3" id="thick_max_3" disabled='disabled'class="form-control" placeholder="두께" /></td>
                    <td colspan="2"><input type="number" name="thick_max_4" id="thick_max_4" disabled='disabled'class="form-control" placeholder="두께" /></td>
                  </tr>
                  <tr>
                    <th colspan="2">길이(mm)</th>
                    <th><input type="text" name="m_length" id="m_length" disabled='disabled' class="form-control"/> mm</th>
                    <td colspan="2"><input type="number" name="length_1" id="length_1" disabled='disabled'class="form-control" placeholder="길이" /></td>
                    <td colspan="2"><input type="number" name="length_2" id="length_2" disabled='disabled'class="form-control" placeholder="길이" /></td>
                    <td colspan="2"><input type="number" name="length_3" id="length_3" disabled='disabled'class="form-control" placeholder="길이" /></td>
                    <td colspan="2"><input type="number" name="length_4" id="length_4" disabled='disabled'class="form-control" placeholder="길이" /></td>
                  </tr>
                  <tr>
                    <th colspan="2">표시사항</th>
                    <th>규정된 표시사항</th>
                    <td colspan="2"><input type="text" name="ps_1" id="ps_1" disabled='disabled' class="form-control" placeholder="표시사항" /></td>
                    <td colspan="2"><input type="text" name="ps_2" id="ps_2" disabled='disabled' class="form-control" placeholder="표시사항" /></td>
                    <td colspan="2"><input type="text" name="ps_3" id="ps_3" disabled='disabled' class="form-control" placeholder="표시사항" /></td>
                    <td colspan="2"><input type="text" name="ps_4" id="ps_4" disabled='disabled' class="form-control" placeholder="표시사항" /></td>
                  </tr>
                  <tr>
                    <th colspan="2">중량(kg)</th>
                    <th><input type="text" name="m_weight" id="m_weight" disabled='disabled' class="form-control"/> </th>
                    <td colspan="2"><input type="number" name="weight_1" id="weight_1" disabled='disabled' class="form-control" placeholder="중량" /></td>
                    <td colspan="2"><input type="number" name="weight_2" id="weight_2" disabled='disabled' class="form-control" placeholder="중량" /></td>
                    <td colspan="2"><input type="number" name="weight_3" id="weight_3" disabled='disabled' class="form-control" placeholder="중량" /></td>
                    <td colspan="2"><input type="number" name="weight_4" id="weight_4" disabled='disabled' class="form-control" placeholder="중량" /></td>
                  </tr>
