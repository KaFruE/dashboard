...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_6_cut";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        document.getElementById('m_out_min').disabled = false;
        document.getElementById('m_out_max').disabled = false;
      ...
      function revisedb()
      {
            var m1 = $('#m_out_min').val();
            var m2 = $('#m_out_max').val();
            var m3 = $('#m_diameter').val();
            var m4 = $('#m_thick_min').val();
            var m5 = $('#m_thick_max').val();
            var m6 = $('#m_length').val();
            var m7 = $('#m_weight').val();


            window.location.href = './input_process6_cut.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7;
            ...
            <?php
              ...
              $sql = "update management_6_cut set
              m_out_min='$m1',m_out_max='$m2',m_diameter='$m3',m_thick_min='$m4',m_thick_max='$m5',m_length='$m6',m_weight='$m7' where m_product='1'";
              if($m1){
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="input_process5.php">제 6 호기</a>
          </li>
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process6_cut.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process6_cut.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process6_cut.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process6_cut.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process6_cut.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="out_min" id="out_min" class="form-control"step='0.01' placeholder="바깥지름" /></td>
                </tr>
                <tr>
                  <th>최대 </th>
                  <th><input type="text" name="m_out_max" id="m_out_max" disabled='disabled' class="form-control"/>mm이하</th>
                  <td colspan="2"><input type="number" name="out_max" id="out_max" class="form-control"step='0.01' placeholder="바깥지름" /></td>
                </tr>
                <tr>
                  <th colspan="2">평균 바깥지름 </th>
                  <th><input type="text" name="m_diameter" id="m_diameter" disabled='disabled' class="form-control"/> mm</th>
                  <td colspan="2"><input type="number" name="diameter" id="diameter" class="form-control"step='0.01' placeholder="평균바깥지름" /></td>
                </tr>
                <tr>
                  <th rowspan="2">두께(mm)</th>
                  <th>최소</th>
                  <th><input type="text" name="m_thick_min" id="m_thick_min" disabled='disabled' class="form-control"/>mm이상</th>
                  <td colspan="2"><input type="number" name="thick_min" id="thick_min" class="form-control"step='0.01' placeholder="두께" /></td>
                </tr>
                <tr>
                  <th>최대</th>
                  <th><input type="text" name="m_thick_max" id="m_thick_max" disabled='disabled' class="form-control"/>mm이하</th>
                  <td colspan="2"><input type="number" name="thick_max" id="thick_max" class="form-control"step='0.01' placeholder="두께" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <th>규정된 표시사항</th>
                  <td colspan="2"><input type="text" name="ps" id="ps" class="form-control" placeholder="표시사항" /></td>
                </tr>
                <tr>
                  <th colspan="2">중량(kg)</th>
                  <th><input type="text" name="m_weight" id="m_weight" disabled='disabled' class="form-control"/> </th>
                  <td colspan="2"><input type="number" name="weight" id="weigth" class="form-control"step='0.01' placeholder="중량" /></td>
                </tr>
