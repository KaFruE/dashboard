...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_6_press";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        ...
        document.getElementById('m_nop_1').disabled = false;
        ...
        document.getElementById('m_nop_2').disabled = false;
        document.getElementById('m_screwrpm').disabled = false;
        document.getElementById('m_screwap').disabled = false;
        document.getElementById('m_hdmoterrpm').disabled = false;
        document.getElementById('m_hdmoterap').disabled = false;
        document.getElementById('m_suzitem').disabled = false;
        document.getElementById('m_suzipre').disabled = false;
        document.getElementById('m_jingon').disabled = false;
        document.getElementById('m_jingonsu').disabled = false;
      ...
      function revisedb()
      {
            ...
            var m9 = $('#m_d4').val();
            var m10 = $('#m_nop_2').val();
            var m11 = $('#m_screwrpm').val();
            var m12 = $('#m_screwap').val();
            var m13 = $('#m_hdmoterrpm').val();
            var m14 = $('#m_hdmoterap').val();
            var m15 = $('#m_suzitem').val();
            var m16 = $('#m_suzipre').val();
            var m17 = $('#m_jingon').val();
            var m18 = $('#m_jingonsu').val();
            var m19 = $('#m_icetem').val();
            var m20 = $('#m_inche').val();


            window.location.href = './input_process6_press.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m14='+m14+'&m15='+m15+
            '&m16='+m16+'&m17='+m17+'&m18='+m18+'&m19='+m19+'&m20='+m20;
            ...
            <?php
              ...
              $sql = "update management_6_press set
              m_c1='$m1',m_c2='$m2',m_c3='$m3',m_c4='$m4',m_nop_1='$m5',m_d1='$m6',m_d2='$m7',m_d3='$m8',m_d4='$m9',m_nop_2='$m10',
              m_screwrpm='$m11',m_screwap='$m12',m_hdmoterrpm='$m13',m_hdmoterap='$m14',m_suzitem='$m15',m_suzipre='$m16',m_jingon='$m17',m_jingonsu='$m18',m_icetem='$m19',m_inche='$m20' where m_product='1'";
              if($m1){
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process6_press.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process6_press.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process6_press.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process6_press.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process6_press.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="nop_1" id="nop_1" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="nop_2" id="nop_2" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="screwap" id="screwap" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>휘드모타 RPM</th>
                  <th><input type="text" name="m_hdmoterrpm" id="m_hdmoterrpm" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="hdmoterrpm" id="hdmoterrpm" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>휘드모타 암페아</th>
                  <th><input type="text" name="m_hdmoterap" id="m_hdmoterap" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="hdmoterap" id="hdmoterap" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="suzipre" id="suzipre" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                  <th colspan="2"=>진공계</th>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="jingonsu" id="jingonsu" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  <th>절단</th>
                  <th colspan="4">길이 (3990~4030mm)</th>
