...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management2_hivp_expand";
            // where date='$date'";
  ...
  <script type="text/javascript">
      ...
      function revisedb()
      {
            ...
            window.location.href = './input_expand_process2_HIVP_expand.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13;
            ...
            <?php
              ...
              $sql = "update management2_hivp_expand set
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a class="btn btn-outline-secondary" href="input_expand_process2_HIVP_work.php">작업일지</a>
          <a class="btn btn-outline-secondary" href="input_expand_process2_HIVP_expand.php">확관성형공정관리일지</a>
        ...
        <form method='post' action='write_expand_process2_HIVP_expand.php'>
