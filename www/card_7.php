...
<head>
  ...
  $(document).ready(function(){
     <?php
         ...
         $rows_1_7 = array();
         while($row_1_7=mysqli_fetch_array($result1_7)) {
           $rows_1_7[] = $row_1_7;
         };
         $rows_2_7 = array();
         while($row_2_7=mysqli_fetch_array($result2_7)) {
           $rows_2_7[] = $row_2_7;
         };
  ...
  <script>
      ...
      foreach($rows_1_7 as $value1_7) {
        ?>
        myArray1_1[i] = "<?=$value1_7['num']?>";
        myArray1_2[i] = "<?=$value1_7['product']?>";
        myArray1_3[i] = "<?=$value1_7['date']?>";
        myArray1_4[i] = "<?=$value1_7['writer']?>";
        myArray1_5[i] = "<?=$value1_7['input_time']?>";
        myArray1_6[i] = "<?=$value1_7['c1']?>";
        myArray1_7[i] = "<?=$value1_7['c2']?>";
        myArray1_8[i] = "<?=$value1_7['c3']?>";
        myArray1_9[i] = "<?=$value1_7['c4']?>";
        myArray1_10[i] = "<?=$value1_7['c5']?>";
        myArray1_11[i] = "<?=$value1_7['c6']?>";
        myArray1_12[i] = "<?=$value1_7['d1']?>";
        myArray1_13[i] = "<?=$value1_7['d2']?>";
        myArray1_14[i] = "<?=$value1_7['d3']?>";
        myArray1_15[i] = "<?=$value1_7['d4']?>";
        myArray1_16[i] = "<?=$value1_7['d5']?>";
        myArray1_17[i] = "<?=$value1_7['nop']?>";
        myArray1_18[i] = "<?=$value1_7['d35']?>";
        myArray1_19[i] = "<?=$value1_7['head']?>";
        myArray1_20[i] = "<?=$value1_7['cart1']?>";
        myArray1_21[i] = "<?=$value1_7['cart2']?>";
        myArray1_22[i] = "<?=$value1_7['jm']?>";
        myArray1_23[i] = "<?=$value1_7['maintalk']?>";
        myArray1_24[i] = "<?=$value1_7['screw']?>";
        myArray1_25[i] = "<?=$value1_7['hdtalk']?>";
        myArray1_26[i] = "<?=$value1_7['hoper']?>";
        myArray1_27[i] = "<?=$value1_7['suzitem']?>";
        myArray1_28[i] = "<?=$value1_7['apjingon']?>";
        myArray1_29[i] = "<?=$value1_7['air']?>";
        myArray1_30[i] = "<?=$value1_7['icepress']?>";
        myArray1_31[i] = "<?=$value1_7['icetem']?>";
        myArray1_32[i] = "<?=$value1_7['up']?>";
        myArray1_33[i] = "<?=$value1_7['down']?>";
        myArray1_34[i] = "<?=$value1_7['in']?>";
        myArray1_35[i] = "<?=$value1_7['out']?>";
        myArray1_36[i] = "<?=$value1_7['rpm']?>";
        myArray1_37[i] = "<?=$value1_7['length']?>";
        myArray1_38[i] = "<?=$value1_7['length_expand']?>";
   ...
   <script>
        ...
        <?php
        foreach($rows_2_7 as $value2_7) {
          ?>
          myArray2_1[i2] = "<?=$value2_7['product']?>";
          myArray2_2[i2] = "<?=$value2_7['date']?>";
          myArray2_3[i2] = "<?=$value2_7['writer']?>";
          myArray2_4[i2] = "<?=$value2_7['input_time']?>";
          myArray2_5[i2] = "<?=$value2_7['appearance']?>";
          myArray2_6[i2] = "<?=$value2_7['color']?>";
          myArray2_7[i2] = "<?=$value2_7['diameter']?>";
          myArray2_8[i2] = "<?=$value2_7['out_max']?>";
          myArray2_9[i2] = "<?=$value2_7['out_min']?>";
          myArray2_10[i2] = "<?=$value2_7['in_max']?>";
          myArray2_11[i2] = "<?=$value2_7['in_min']?>";
          myArray2_12[i2] = "<?=$value2_7['gol_max']?>";
          myArray2_13[i2] = "<?=$value2_7['gol_min']?>";
          myArray2_14[i2] = "<?=$value2_7['display']?>";
          myArray2_15[i2] = "<?=$value2_7['length']?>";
          myArray2_16[i2] = "<?=$value2_7['weight']?>";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">7호기 데이터베이스</li>
        </ol>
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-danger mb-3 h-100">
              <div class="card-header">당일 7호기 압출 데이터 수</div>
                <div class="card-body text-danger">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">7호기 압출의 데이터 수</h5>
                  <div class="mr-5"><?=$row11_7?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-warning mb-3 h-100">
              <div class="card-header">당일 7호기 절단 데이터 수</div>
                <div class="card-body text-warning">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">7호기 절단의 데이터 수</h5>
                  <div class="mr-5"><?=$row12_7?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-success mb-3 h-100">
              <div class="card-header">당일 7호기 수량 데이터 수</div>
                <div class="card-body text-success">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">7호기 수량의 데이터 수</h5>
                  <div class="mr-5"><?= $row13_7?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-info mb-3 success h-100">
              <div class="card-header">당일 7호기 배합 데이터 수</div>
                <div class="card-body text-info">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title"> 7호기 배합의 데이터 수</h5>
                  <div class="mr-5"><?= $row15_7?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-primary mb-3 h-100">
              <div class="card-header">당일 7호기 기타 데이터 수</div>
                <div class="card-body text-primary">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">7호기 기타의 데이터 수</h5>
                  <div class="mr-5"><?= $row14_7?> 개</div>
                </div>
            </div>
          </div>
