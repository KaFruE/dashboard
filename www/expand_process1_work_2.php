...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from expandhogi01_work where date='$dt' AND  checktime_1  NOT BETWEEN '06:00:01' AND '18:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './expand_process1_work_2.php?date=' + value;
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="expand_process1.php">제 확관 1 호기</a>
          </li>
          <li class="breadcrumb-item active">
        ...
        <ol class="bread">
          <a class="btn btn-outline-danger" href="expand_process1_work_1.php">주간</a>
          <a class="btn btn-outline-primary" href="expand_process1_work_2.php">야간</a>
        ...
        <!-- Page Content -->
        <form method='post' action='revise_expand_process1_work.php'>
