...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_2_cut";
            // where date='$date'";
  ...
  <script type="text/javascript">
      ...
      function revisedb()
      {
            ...
            window.location.href = './input_process2_cut.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7;
            ...
            <?php
              ...
              $sql = "update management_2_cut set
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process2_cut.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process2_cut.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process2_cut.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process2_cut.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process2_cut.php'>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  <th colspan="3">중량</th>
                  <td colspan="2"><input type="number" name="weight" id="weight" class="form-control"step='0.01' placeholder="중량" /></td>
                </tr>
              </tbody>
            </table>
          </div>
