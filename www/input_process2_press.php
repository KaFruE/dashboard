...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_2_press";
            // where date='$date'";
        ...
        document.getElementById('m_tolk').value= "<?= $row['m_tolk']?>";
  ...
  <script type="text/javascript">
      function actdb()
      {
        ...
        document.getElementById('m_tolk').disabled = false;
      ...
      function revisedb()
      {
            ...
            var m17 = $('#m_d8').val();
            var m18 = $('#m_jm').val();
            var m19 = $('#m_jingon').val();
            var m20 = $('#m_hdmoter').val();
            var m21 = $('#m_screw').val();
            var m22 = $('#m_tolk').val();
            var m23 = $('#m_icetem').val();
            var m24 = $('#m_corogate').val();


            window.location.href = './input_process2_press.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m14='+m14+'&m15='+m15+
            '&m16='+m16+'&m17='+m17+'&m18='+m18+'&m19='+m19+'&m20='+m20+'&m21='+m21+'&m22='+m22+'&m23='+m23+'&m24='+m24;
            ...
            <?php
              ...
              $sql = "update management_2_press set
              m_c1='$m1',m_c2='$m2',m_c3='$m3',m_c4='$m4',m_c5='$m5',m_c6='$m6',m_c7='$m7',m_c8='$m8',m_H='$m9',m_d1='$m10',m_d2='$m11',m_d3='$m12',m_d4='$m13',m_d5='$m14',m_d6='$m15',m_d7='$m16',m_d8='$m17',m_jm='$m18',m_jingon='$m19',m_hdmoter='$m20',m_screw='$m21',m_tolk='$m22',m_icetem='$m23',m_corogate='$m24'
               where m_product='1'";
              if($m1){
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="input_process2.php">제 2 호기</a>
          </li>
          <li class="breadcrumb-item active">압출</li>
        </ol>

        <ol class="bread">
          <a class="btn btn-outline-secondary" href="input_process2_mix.php">배합</a>
          <a class="btn btn-outline-secondary" href="input_process2_press.php">압출</a>
          <a class="btn btn-outline-secondary" href="input_process2_cut.php">검사</a>
          <a class="btn btn-outline-secondary" href="input_process2_count.php">수량</a>
          <a class="btn btn-outline-secondary" href="input_process2_other.php">기타</a>
        </ol>
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process2_press.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process2_press.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process2_press.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process2_press.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process2_press.php'>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  <th colspan="2"=>토크</th>
                  <th><input type="text" name="m_tolk" id="m_tolk" disabled='disabled' class="form-control"/></th>
                  <td colspan="2"><input type="number" name="tolk" id="tolk" class="form-control" step='0.01' placeholder="온도" /></td>
                </tr>
                <tr>
