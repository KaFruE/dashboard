...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from expandhogi02_hivp_work where date='$dt' AND  checktime_1  NOT BETWEEN '06:00:01' AND '18:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './expand_process2_HIVP_work_2.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a class="btn btn-outline-danger" href="expand_process2_HIVP_work_1.php">주간</a>
          <a class="btn btn-outline-primary" href="expand_process2_HIVP_work_2.php">야간</a>
        ...
        <!-- Page Content -->
        <form method='post' action='revise_expand_process2_HIVP_work_2.php'>
