  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process2_mix.php">야간</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process2_mix.php">주간</a>
        </ol>

      </br></br>

      <form method='post' action='write_process2_mix.php'>
