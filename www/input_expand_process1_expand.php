...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_expand";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        ...
        document.getElementById('m_golength').disabled = false;
        document.getElementById('m_icetime').disabled = false;
      ...
      {
            var m1 = $('#m_length').val();
            var m2 = $('#m_heattem').val();
            var m3 = $('#m_heattime').val();
            var m4 = $('#m_golength').val();
            var m5 = $('#m_icetime').val();
            var m6 = $('#m_nop').val();
            var m7 = $('#m_icetem').val();
            var m8 = $('#m_indiameter').val();
            var m9 = $('#m_inputlength').val();
            var m10 = $('#m_jglength').val();


            window.location.href = './input_expand_process1_expand.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7+'&m8='+m8+'&m9='+m9+'&m10='+m10;
            ...
            <?php
              ...
              $sql = "update management_expand set
              m_length='$m1',m_heattem='$m2',m_heattime='$m3',m_golength='$m4',m_icetime='$m5',m_nop='$m6',m_icetem='$m7',m_indiameter='$m8',m_inputlength='$m9',m_jglength='$m10'
               where m_product='1'";
              if($m1){
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">제 확관1 호기</li>
        </ol>
        <ol class="bread">
          <a class="btn btn-outline-secondary" href="input_expand_process1_work.php">작업일지</a>
          <a class="btn btn-outline-secondary" href="input_expand_process1_expand.php">확관성형공정관리일지</a>
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_expand_process1_expand.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_expand_process1_expand.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_expand_process1_expand.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_expand_process1_expand.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_expand_process1_expand.php'>
          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead>
              ...
              <tr>
                ...
                <td><input type="number" name="length" id="length" class="form-control"  step="0.01"placeholder="정렬길이" /></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input type="number" name="golength" id="golength" class="form-control" step="0.01" placeholder="전진길이" /></td>
              </tr>
              <tr>
                  <th>냉각시간</th>
                  <th><input type="text" name="m_icetime" id="m_icetime" disabled='disabled' class="form-control"/></th>
                  <td><input type="number" name="icetime" id="icetime" class="form-control" step="0.01" placeholder="냉각시간" /></td>
              </tr>
              <tr>
                <th colspan="2">에어</th>
                <th><input type="text" name="m_nop" id="m_nop" disabled='disabled' class="form-control"/></th>
                <td><input type="text" name="nop" id="nop" class="form-control" placeholder="이상없을것" /></td>
              </tr>
              <tr>
                <th colspan="2">냉각수온도</th>
                <th><input type="text" name="m_icetem" id="m_icetem" disabled='disabled' class="form-control"/></th>
                <td><input type="number" name="icetem" id="icetem" class="form-control" step="0.01" placeholder="온도" /></td>
              </tr>
              <tr>
