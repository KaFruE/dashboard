...
<head>
  ...
  $(document).ready(function(){
     <?php
         ...
         $rows_1_2 = array();
         while($row_1_2=mysqli_fetch_array($result1_2)) {
           $rows_1_2[] = $row_1_2;
         };
         $rows_2_2 = array();
         while($row_2_2=mysqli_fetch_array($result2_2)) {
           $rows_2_2[] = $row_2_2;
         };
  ...
  <script>
      ...
      foreach($rows_1_2 as $value1_2) {
        ?>
        myArray1_1[i] = "<?=$value1_2['num']?>";
        myArray1_2[i] = "<?=$value1_2['product']?>";
        myArray1_3[i] = "<?=$value1_2['date']?>";
        myArray1_4[i] = "<?=$value1_2['writer']?>";
        myArray1_5[i] = "<?=$value1_2['input_time']?>";
        myArray1_6[i] = "<?=$value1_2['c1']?>";
        myArray1_7[i] = "<?=$value1_2['c2']?>";
        myArray1_8[i] = "<?=$value1_2['c3']?>";
        myArray1_9[i] = "<?=$value1_2['c4']?>";
        myArray1_10[i] = "<?=$value1_2['c5']?>";
        myArray1_11[i] = "<?=$value1_2['c6']?>";
        myArray1_12[i] = "<?=$value1_2['c7']?>";
        myArray1_13[i] = "<?=$value1_2['c8']?>";
        myArray1_14[i] = "<?=$value1_2['H']?>";
        myArray1_15[i] = "<?=$value1_2['d1']?>";
        myArray1_16[i] = "<?=$value1_2['d2']?>";
        myArray1_17[i] = "<?=$value1_2['d3']?>";
        myArray1_18[i] = "<?=$value1_2['d4']?>";
        myArray1_19[i] = "<?=$value1_2['d5']?>";
        myArray1_20[i] = "<?=$value1_2['d6']?>";
        myArray1_21[i] = "<?=$value1_2['d7']?>";
        myArray1_22[i] = "<?=$value1_2['d8']?>";
        myArray1_23[i] = "<?=$value1_2['jm']?>";
        myArray1_24[i] = "<?=$value1_2['jingon']?>";
        myArray1_25[i] = "<?=$value1_2['hdmoter']?>";
        myArray1_26[i] = "<?=$value1_2['screw']?>";
        myArray1_27[i] = "<?=$value1_2['tolk']?>";
        myArray1_28[i] = "<?=$value1_2['icetem']?>";
        myArray1_29[i] = "<?=$value1_2['corogate']?>";
        myArray1_20[i] = "<?=$value1_2['tube']?>";
        myArray1_31[i] = "<?=$value1_2['length']?>";
   ...
   <script>
        ...
        <?php
        foreach($rows_2_2 as $value2_2) {
          ?>
          myArray2_1[i2] = "<?=$value2_2['product']?>";
          myArray2_2[i2] = "<?=$value2_2['date']?>";
          myArray2_3[i2] = "<?=$value2_2['writer']?>";
          myArray2_4[i2] = "<?=$value2_2['input_time']?>";
          myArray2_5[i2] = "<?=$value2_2['appearance']?>";
          myArray2_6[i2] = "<?=$value2_2['color']?>";
          myArray2_7[i2] = "<?=$value2_2['diameter']?>";
          myArray2_8[i2] = "<?=$value2_2['out_max']?>";
          myArray2_9[i2] = "<?=$value2_2['out_min']?>";
          myArray2_10[i2] = "<?=$value2_2['in_max']?>";
          myArray2_11[i2] = "<?=$value2_2['in_min']?>";
          myArray2_12[i2] = "<?=$value2_2['gol_max']?>";
          myArray2_13[i2] = "<?=$value2_2['gol_min']?>";
          myArray2_14[i2] = "<?=$value2_2['display']?>";
          myArray2_15[i2] = "<?=$value2_2['length']?>";
          myArray2_16[i2] = "<?=$value2_2['weight']?>";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">2호기 데이터베이스</li>
        </ol>
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-danger mb-3 h-100">
              <div class="card-header">당일 2호기 압출 데이터 수</div>
                <div class="card-body text-danger">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">2호기 압출의 데이터 수</h5>
                  <div class="mr-5"><?=$row11_2?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-warning mb-3 h-100">
              <div class="card-header">당일 2호기 절단 데이터 수</div>
                <div class="card-body text-warning">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">2호기 절단의 데이터 수</h5>
                  <div class="mr-5"><?=$row12_2?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-success mb-3 h-100">
              <div class="card-header">당일 2호기 수량 데이터 수</div>
                <div class="card-body text-success">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">2호기 수량의 데이터 수</h5>
                  <div class="mr-5"><?= $row13_2?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-info mb-3 success h-100">
              <div class="card-header">당일 2호기 배합 데이터 수</div>
                <div class="card-body text-info">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title"> 2호기 배합의 데이터 수</h5>
                  <div class="mr-5"><?= $row15_2?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-primary mb-3 h-100">
              <div class="card-header">당일 2호기 기타 데이터 수</div>
                <div class="card-body text-primary">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">2호기 기타의 데이터 수</h5>
                  <div class="mr-5"><?= $row14_2?> 개</div>
                </div>
            </div>
          </div>
