...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_1_cut_hivp";
            // where date='$date'";
  ...
  <script type="text/javascript">
      function actdb()
      {
        document.getElementById('m_diameter_min').disabled = false;
        document.getElementById('m_diameter_max').disabled = false;
        document.getElementById('m_diameter_avg').disabled = false;
      ...
      function revisedb()
      {
            var m1 = $('#m_diameter_min').val();
            var m2 = $('#m_diameter_max').val();
            var m3 = $('#m_diameter_avg').val();
            ...
            window.location.href = './input_process1_cut_hivp.php?m1='+m1+'&m2='+m2+'&m3='+m3+'&m4='+m4+'&m5='+m5+'&m6='+m6+'&m7='+m7;
            ...
            <?php
              ...
              $sql = "update management_1_cut_hivp set
              m_diameter_min='$m1',m_diameter_max='$m2',m_diameter_avg='$m3',m_thick_min='$m4',m_thick_max='$m5',m_length='$m6',m_weight='$m7' where m_product='1'";
              if($m1){
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process1_cut_hivp.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process1_cut_hivp.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process1_cut_hivp.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process1_cut_hivp.php">08:00~12:00</a>
        </ol>
        <br/><br/>

        <form method='post' action='write_process1_cut_hivp.php'>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td colspan="2"><input type="number" name="diameter_min" id="diameter_min" class="form-control"step='0.01' placeholder="바깥지름" /></td>

                </tr>
                <tr>
                 <th>최대</th>
                 <th> <input type="text" name="m_diameter_max" id="m_diameter_max" disabled='disabled' class="form-control"/>이하</th>
                 <td colspan="2"><input type="number" name="diameter_max" id="diameter_max" class="form-control"step='0.01' placeholder="바깥지름" /></td>
                </tr>
                <tr>
                 <th>평균</th>
                 <th> <input type="text" name="m_diameter_avg" id="m_diameter_avg" disabled='disabled' class="form-control"/></th>
                 <td colspan="2"><input type="number" name="diameter_avg" id="diameter_avg" class="form-control"step='0.01' placeholder="바깥지름" /></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <th>규정된 표시사항</th>
                  <td><input type="text" name="ps" id="ps" class="form-control" placeholder="표시사항" /></td>
                </tr>
                <tr>
