<?php
	...
	header("Content-Type:text/html;charset=utf-8");
	  ...
	  $sql = "update hogi01_other set
		...
		checktime_1='$checktime_1',checktime_2='$checktime_2',checktime_3='$checktime_3',checktime_4='$checktime_4',checktime_5='$checktime_5',checktime_6='$checktime_6',checktime_7='$checktime_7',checktime_8='$checktime_8',checktime_9='$checktime_9',checktime_10='$checktime_10' where date='$date'";
