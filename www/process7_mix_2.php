...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from hogi07_mix where date='$dt' AND  checktime_1  NOT BETWEEN '06:00:01' AND '18:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process7_mix_2.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a class="btn btn-outline-danger" href="process7_mix_1.php">주간</a>
          <a class="btn btn-outline-primary" href="process7_mix_2.php">야간</a>
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process7_mix_2.php'>
