...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_expand_3 where m_product='1'";
            // where date='$date'";
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1 = "select * from expandhogi03_expand where date='$dt' AND INput_time BETWEEN'06:00:01' AND '12:00:00'";
        $query2 = "select * from expandhogi03_expand where date='$dt' AND INput_time BETWEEN'12:00:01' AND '18:00:00'";
        $query3 = "select * from expandhogi03_expand where date='$dt' AND INput_time BETWEEN'18:00:01' AND '23:59:59'";
        $query4 = "select * from expandhogi03_expand where date='$dt' AND INput_time BETWEEN'00:00:00' AND '06:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './expand_process3_expand.php?date=' + value;
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="expand_process3.php">제 확관3 호기</a>
          </li>
        ...
        <!-- Page Content -->
        <form method='post' action='revise_expand_process3_expand.php'>
