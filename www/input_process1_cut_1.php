  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a id="clock1" class="btn btn-dark float-right clocks" href="input_process1_cut_1.php">01:00~06:00</a>
          <a id="clock2" class="btn btn-dark float-right clocks" href="input_process1_cut_1.php">19:00~24:00</a>
          <a id="clock3" class="btn btn-dark float-right clocks" href="input_process1_cut_1.php">13:00~18:00</a>
          <a id="clock4" class="btn btn-dark float-right clocks" href="input_process1_cut_1.php">08:00~12:00</a>
        </ol>
        <br/><br/>


      <form method='post' action='write_process1_cut.php'>
        ...
        <div class="table-responsive">
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              <tr>
                <th colspan="3">겉모양</th>
                <td><input type="text" name="appearance" id="appearance" class="form-control" placeholder="양호" /></td>
              </tr>
              <tr>
              ...
              <tr>
                <th colspan="3">평균바깥지름 356+-1.35mm</th>
                <td><input type="number" name="diameter" id="diameter" class="form-control" placeholder="바깥지름" /></td>
              </tr>
              <tr>
                <th rowspan="6">최소두께(mm)</th>
                <th rowspan="2">바깥벽 1.3</th>
                <th>최대</th>
                <td><input type="number" name="out_max" id="out_max" class="form-control" placeholder="최대" /></td>
              </tr>
              <tr>
                <th>최소</th>
                <td><input type="number" name="out_min" id="outmin" class="form-control" placeholder="최소" /></td>
              </tr>
              <tr>
                <th rowspan="2">안벽 1.7</th>
                <th>최대</th>
                <td><input type="number" name="in_max" id="in_max" class="form-control" placeholder="최대" /></td>
              </tr>
              <tr>
                <th>최소</th>
                <td><input type="number" name="in_min" id="in_min" class="form-control" placeholder="최소" /></td>
              </tr>
              <tr>
                <th rowspan="2">골 2.2</th>
                <th>최대</th>
                <td><input type="number" name="gol_max" id="gol_max" class="form-control" placeholder="최대" /></td>
              </tr>
              <tr>
                <th>최소</th>
                <td><input type="number" name="gol_min" id="golmin" class="form-control" placeholder="최소" /></td>
              </tr>
              <tr>
                <th>피치</th>
                <th>40.0mm</th>
                <th>최대</th>
                <th>33.0mm(몰드 변경 전 동일)</th>
              </tr>
              <tr>
                <th colspan="2">표시사항</th>
                <th>규정된 표시사항</th>
                <td><input type="text" name="display" id="display" class="form-control" placeholder="양호" /></td>
              </tr>
              <tr>
                <th colspan="3">길이(6000~6300mm)</th>
                <td><input type="number" name="length" id="length" class="form-control" placeholder="길이" /></td>
              </tr>
              <tr>
                <th colspan="3">중량</th>
                <td><input type="number" name="weight" id="weight" class="form-control" placeholder="중량" /></td>
              </tr>
            </tbody>
          </table>
        </div>
