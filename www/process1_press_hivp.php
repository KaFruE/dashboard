...
<head>
  ...
  <script type="text/javascript">
      $(document).ready(function() {
        <?php
            ...
            $query = "select * from management_1_press_hivp where m_product='1'";
            // where date='$date'";
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1 = "select * from hogi01_press_hivp where date='$dt' AND INput_time BETWEEN'06:00:01' AND '12:00:00'";
        $query2 = "select * from hogi01_press_hivp where date='$dt' AND INput_time BETWEEN'12:00:01' AND '18:00:00'";
        $query3 = "select * from hogi01_press_hivp where date='$dt' AND INput_time BETWEEN'18:00:01' AND '23:59:59'";
        $query4 = "select * from hogi01_press_hivp where date='$dt' AND INput_time BETWEEN'00:00:00' AND '06:00:00'";
    ...
    document.getElementById('H_2_4').value= "<?= $row4['H_2']?>";
    ...
    document.getElementById('inmoter_4').value= "<?= $row4['inmoter']?>";
    document.getElementById('inscrew_4').value= "<?= $row4['inscrew']?>";
    ...
    document.getElementById('H_2_1').value= "<?= $row1['H_2']?>";
    ...
    document.getElementById('inmoter_1').value= "<?= $row1['inmoter']?>";
    document.getElementById('inscrew_1').value= "<?= $row1['inscrew']?>";
    ...
    document.getElementById('H_2_2').value= "<?= $row2['H_2']?>";
    ...
    document.getElementById('inmoter_2').value= "<?= $row2['inmoter']?>";
    document.getElementById('inscrew_2').value= "<?= $row2['inscrew']?>";
    ...
    document.getElementById('H_2_3').value= "<?= $row3['H_2']?>";
    ...
    document.getElementById('inmoter_3').value= "<?= $row3['inmoter']?>";
    document.getElementById('inscrew_3').value= "<?= $row3['inscrew']?>";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process1_press_hivp.php?date=' + value;
  ...
  <script type="text/javascript">
    ...
    function revisedb(){
      ...
      document.getElementById('H_2_1').disabled = false;
      ...
      document.getElementById('inmoter_1').disabled = false;
      document.getElementById('inscrew_1').disabled = false;
      ...
      document.getElementById('H_2_2').disabled = false;
      ...
      document.getElementById('inmoter_2').disabled = false;
      document.getElementById('inscrew_2').disabled = false;
      ...
      document.getElementById('H_2_3').disabled = false;
      ...
      document.getElementById('inmoter_3').disabled = false;
      document.getElementById('inscrew_3').disabled = false;
      ...
      document.getElementById('H_2_4').disabled = false;
      ...
      document.getElementById('inmoter_4').disabled = false;
      document.getElementById('inscrew_4').disabled = false;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process1_press_hivp.php'>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input type="number" name="H_2_1" id="H_2_1" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="H_2_2" id="H_2_2" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="H_2_3" id="H_2_3" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="H_2_4" id="H_2_4" class="form-control" disabled='disabled' placeholder="온도" /></td>
                  </tr>
                  <tr>
                    <th >코렉스</th>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><input type="number" name="inmoter_1" id="inmoter_1" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="inmoter_2" id="inmoter_2" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="inmoter_3" id="inmoter_3" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="inmoter_4" id="inmoter_4" class="form-control" disabled='disabled' placeholder="온도" /></td>
                  </tr>
                  <tr>
                    <th colspan="2"=>내피 스크류 RPM</th>
                    <th><input type="text" name="m_inscrew" id="m_inscrew" disabled='disabled' class="form-control"/></th>
                    <td colspan="2"><input type="number" name="inscrew_1" id="inscrew_1" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="inscrew_2" id="inscrew_2" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="inscrew_3" id="inscrew_3" class="form-control" disabled='disabled' placeholder="온도" /></td>
                    <td colspan="2"><input type="number" name="inscrew_4" id="inscrew_4" class="form-control" disabled='disabled' placeholder="온도" /></td>
                  </tr>
                  <tr>
                    <th colspan="2"=>진공계</th>
