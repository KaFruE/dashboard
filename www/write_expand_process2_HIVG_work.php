...
$connect = mysqli_connect("localhost", "yook6442", "yug6442!", "yook6442") or die("fail");
  ...
  $sql = "insert into expandhogi02_hivg_work values
	('$date','$checktime_1','$writer','$product_1','$warehousing_1','$fail_count_1','$amount_1','$worktime_1','$stoptime_1','$giho_1','$failweight_1','$giho2_1','$product_2','$warehousing_2','$fail_count_2','$amount_2','$worktime_2','$stoptime_2','$giho_2','$failweight_2','$giho2_2','$pm_1','$br_1','$pm_2','$br_2')";
