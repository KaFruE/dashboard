...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from hogi05_other where date='$dt'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process5_other.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process5_other.php'>
