...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from expandhogi01_work where date='$dt' AND checktime_1 BETWEEN '06:00:01' AND '18:00:00' ";
  ...
  function input_Text()
  {
    ...
    window.location.href = './expand_process1_work_1.php?date=' + value;
