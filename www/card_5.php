...
<head>
  ...
  $(document).ready(function(){
     <?php
         ...
         $rows_1_5 = array();
         while($row_1_5=mysqli_fetch_array($result1_5)) {
           $rows_1_5[] = $row_1_5;
         };
         $rows_2_5 = array();
         while($row_2_5=mysqli_fetch_array($result2_5)) {
           $rows_2_5[] = $row_2_5;
         };
  ...
  <script>
      ...
      var myArray1_37 = new Array();
      var myArray1_38 = new Array();
      ...
      foreach($rows_1_5 as $value1_5) {
        ?>
        myArray1_1[i] = "<?=$value1_5['num']?>";
        myArray1_2[i] = "<?=$value1_5['product']?>";
        myArray1_3[i] = "<?=$value1_5['date']?>";
        myArray1_4[i] = "<?=$value1_5['writer']?>";
        myArray1_5[i] = "<?=$value1_5['input_time']?>";
        myArray1_6[i] = "<?=$value1_5['c1']?>";
        myArray1_7[i] = "<?=$value1_5['c2']?>";
        myArray1_8[i] = "<?=$value1_5['c3']?>";
        myArray1_9[i] = "<?=$value1_5['c4']?>";
        myArray1_10[i] = "<?=$value1_5['c5']?>";
        myArray1_11[i] = "<?=$value1_5['d1']?>";
        myArray1_12[i] = "<?=$value1_5['d2']?>";
        myArray1_13[i] = "<?=$value1_5['d3']?>";
        myArray1_14[i] = "<?=$value1_5['d4']?>";
        myArray1_15[i] = "<?=$value1_5['d6']?>";
        myArray1_16[i] = "<?=$value1_5['d7']?>";
        myArray1_17[i] = "<?=$value1_5['d8']?>";
        myArray1_18[i] = "<?=$value1_5['d9']?>";
        myArray1_19[i] = "<?=$value1_5['d10']?>";
        myArray1_20[i] = "<?=$value1_5['d35']?>";
        myArray1_21[i] = "<?=$value1_5['dopit']?>";
        myArray1_22[i] = "<?=$value1_5['cartridge']?>";
        myArray1_23[i] = "<?=$value1_5['jumul']?>";
        myArray1_24[i] = "<?=$value1_5['maintoke']?>";
        myArray1_25[i] = "<?=$value1_5['screwrpm']?>";
        myArray1_26[i] = "<?=$value1_5['hoodtoke']?>";
        myArray1_27[i] = "<?=$value1_5['hoodrpm']?>";
        myArray1_28[i] = "<?=$value1_5['vacuum']?>";
        myArray1_29[i] = "<?=$value1_5['air_a']?>";
        myArray1_30[i] = "<?=$value1_5['air_i']?>";
        myArray1_31[i] = "<?=$value1_5['cold_degree']?>";
        myArray1_32[i] = "<?=$value1_5['up']?>";
        myArray1_33[i] = "<?=$value1_5['down']?>";
        myArray1_34[i] = "<?=$value1_5['degree_in']?>";
        myArray1_35[i] = "<?=$value1_5['degree_out']?>";
        myArray1_36[i] = "<?=$value1_5['rpm']?>";
        myArray1_37[i] = "<?=$value1_5['tube']?>";
        myArray1_38[i] = "<?=$value1_5['length']?>";
   ...
   <script>
        ...
        <?php
        foreach($rows_2_5 as $value2_5) {
          ?>
          myArray2_1[i2] = "<?=$value2_5['product']?>";
          myArray2_2[i2] = "<?=$value2_5['date']?>";
          myArray2_3[i2] = "<?=$value2_5['writer']?>";
          myArray2_4[i2] = "<?=$value2_5['input_time']?>";
          myArray2_5[i2] = "<?=$value2_5['appearance']?>";
          myArray2_6[i2] = "<?=$value2_5['color']?>";
          myArray2_7[i2] = "<?=$value2_5['diameter']?>";
          myArray2_8[i2] = "<?=$value2_5['out_max']?>";
          myArray2_9[i2] = "<?=$value2_5['out_min']?>";
          myArray2_10[i2] = "<?=$value2_5['in_max']?>";
          myArray2_11[i2] = "<?=$value2_5['in_min']?>";
          myArray2_12[i2] = "<?=$value2_5['gol_max']?>";
          myArray2_13[i2] = "<?=$value2_5['gol_min']?>";
          myArray2_14[i2] = "<?=$value2_5['display']?>";
          myArray2_15[i2] = "<?=$value2_5['length']?>";
          myArray2_16[i2] = "<?=$value2_5['weight']?>";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">5호기 데이터베이스</li>
        </ol>
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-danger mb-3 h-100">
              <div class="card-header">당일 5호기 압출 데이터 수</div>
                <div class="card-body text-danger">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">5호기 압출의 데이터 수</h5>
                  <div class="mr-5"><?=$row11_5?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-warning mb-3 h-100">
              <div class="card-header">당일 5호기 절단 데이터 수</div>
                <div class="card-body text-warning">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">5호기 절단의 데이터 수</h5>
                  <div class="mr-5"><?=$row12_5?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-success mb-3 h-100">
              <div class="card-header">당일 5호기 수량 데이터 수</div>
                <div class="card-body text-success">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">5호기 수량의 데이터 수</h5>
                  <div class="mr-5"><?= $row13_5?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-info mb-3 success h-100">
              <div class="card-header">당일 5호기 배합 데이터 수</div>
                <div class="card-body text-info">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title"> 5호기 배합의 데이터 수</h5>
                  <div class="mr-5"><?= $row15_5?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-primary mb-3 h-100">
              <div class="card-header">당일 5호기 기타 데이터 수</div>
                <div class="card-body text-primary">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">5호기 기타의 데이터 수</h5>
                  <div class="mr-5"><?= $row14_5?> 개</div>
                </div>
            </div>
          </div>
                ...
                <tbody>
                  <script type="text/javascript">
                    ...
                    for(j=0; j<i; j++)
                    {
                      ...
                      document.write("<td>"+myArray1_37[j]+"</td>");
                      document.write("<td>"+myArray1_38[j]+"</td>");
                      document.write("</tr>");
                    }
                  </script>
                </tbody>
