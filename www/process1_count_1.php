...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query1_1= "select * from hogi01_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";
        $query2_1= "select * from hogi02_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";
        $query3_1= "select * from hogi03_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";
        $query4_1= "select * from hogi04_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";
        $query5_1= "select * from hogi05_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";
        $query6_1= "select * from hogi06_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";
        $query7_1= "select * from hogi07_other where date='$dt' AND CHECKTIME_1 BETWEEN'06:00:01' AND '18:00:00'";

        $query1_b = "select * from hogi01_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query2_b = "select * from hogi02_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query3_b = "select * from hogi03_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query4_b = "select * from hogi04_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query5_b = "select * from hogi05_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query6_b = "select * from hogi06_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query7_b = "select * from hogi07_count where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query1_1_b= "select * from hogi01_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query2_1_b= "select * from hogi02_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query3_1_b= "select * from hogi03_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query4_1_b= "select * from hogi04_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query5_1_b= "select * from hogi05_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query6_1_b= "select * from hogi06_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
        $query7_1_b= "select * from hogi07_other where date='$dt' AND CHECKTIME_1 BETWEEN'18:00:01' AND '24:00:00' OR CHECKTIME_1 BETWEEN'24:00:01' AND '06:00:00'";
    ...
    document.getElementById('writer1').value= "<?= $row1['writer']?>";
    document.getElementById('writer2').value= "<?= $row2['writer']?>";
    document.getElementById('writer3').value= "<?= $row3['writer']?>";
    document.getElementById('writer4').value= "<?= $row3['writer']?>";
    document.getElementById('writer5').value= "<?= $row5['writer']?>";
    document.getElementById('writer6').value= "<?= $row6['writer']?>";
    document.getElementById('writer7').value= "<?= $row7['writer']?>";
    ...
    document.getElementById('standard_11').value= "<?= $row1['standard_1']?>";
    document.getElementById('amount_11').value= <?= $row1['amount_1']?>+<?= $row1_b['amount_1']?>;
    document.getElementById('perweight_11').value= <?= $row1['perweight_1']?>+<?= $row1_b['perweight_1']?>;
    document.getElementById('weight_11').value= <?= $kg1?>+<?=$kg1_b?>;
    document.getElementById('worktime_11').value= <?= $worktime_1_1?>+<?= $worktime_1_1_b?>;
    document.getElementById('stoptime_11').value= <?= $stop1?>+<?= $stop1_b?>;
    document.getElementById('stopsign_11').value= "<?= $row1['br_1']?>"+" "+"<?= $row1_b['br_1']?>";
    document.getElementById('badweight_11').value= <?= $row1['failure_1']?>+<?= $row1_b['failure_1']?>;
    document.getElementById('badsign_11').value= "<?= $row1['failurereason_1']?>"+" "+"<?= $row1_b['failurereason_1']?>";


    document.getElementById('standard_12').value= "<?= $row1['standard_2']?>";
    document.getElementById('amount_12').value= <?= $row1['amount_2']?>+<?= $row1_b['amount_2']?>;
    document.getElementById('perweight_12').value= <?= $row1['perweight_2']?>+<?= $row1_b['perweight_2']?>;
    document.getElementById('weight_12').value= <?= $kg1_2?>+<?=$kg1_2_b?>;
    document.getElementById('worktime_12').value= <?= $worktime_1_1?>+<?= $worktime_1_1_b?>;
    document.getElementById('stoptime_12').value= <?= $stop1?>+<?= $stop1_b?>;
    document.getElementById('stopsign_12').value= "<?= $row1['br_2']?>"+" "+"<?= $row1_b['br_2']?>";
    document.getElementById('badweight_12').value=  <?= $row1['failure_2']?>+<?= $row1_b['failure_2']?>;
    document.getElementById('badsign_12').value= "<?= $row1['failurereason_2']?>"+" "+"<?= $row1_b['failurereason_2']?>";


    document.getElementById('standard_13').value= "<?= $row1['standard_3']?>";
    document.getElementById('amount_13').value= <?= $row1['amount_3']?>+<?= $row1_b['amount_3']?>;
    document.getElementById('perweight_13').value= <?= $row1['perweight_3']?>+<?= $row1_b['perweight_3']?>;
    document.getElementById('weight_13').value= <?= $kg1_3?>+<?=$kg1_3_b?>;
    document.getElementById('worktime_13').value= <?= $worktime_1_1?>+<?= $worktime_1_1_b?>;
    document.getElementById('stoptime_13').value= <?= $stop1?>+<?= $stop1_b?>;
    document.getElementById('stopsign_13').value= "<?= $row1['br_3']?>"+" "+"<?= $row1_b['br_3']?>";
    document.getElementById('badweight_13').value= <?= $row1['failure_3']?>+<?= $row1_b['failure_3']?>;
    document.getElementById('badsign_13').value= "<?= $row1['failurereason_3']?>"+" "+"<?= $row1_b['failurereason_3']?>";
    ...
    document.getElementById('standard_21').value= "<?= $row2['standard_1']?>";
    document.getElementById('amount_21').value= <?= $row2['amount_1']?>+<?= $row2_b['amount_1']?>;
    document.getElementById('perweight_21').value= <?= $row2['perweight_1']?>+<?= $row2_b['perweight_1']?>;
    document.getElementById('weight_21').value= <?= $kg2?>+<?=$kg2_b?>;
    document.getElementById('worktime_21').value= <?= $worktime_2_1?>+<?= $worktime_2_1_b?>;
    document.getElementById('stoptime_21').value= <?= $stop2?>+<?= $stop2_b?>;
    document.getElementById('stopsign_21').value= "<?= $row2['br_1']?>"+" "+"<?= $row2_b['br_1']?>";
    document.getElementById('badweight_21').value= <?= $row2['failure_1']?>+<?= $row2_b['failure_1']?>;
    document.getElementById('badsign_21').value= "<?= $row2['failurereason_1']?>"+" "+"<?= $row2_b['failurereason_1']?>";


    document.getElementById('standard_22').value= "<?= $row2['standard_2']?>";
    document.getElementById('amount_22').value= <?= $row2['amount_2']?>+<?= $row2_b['amount_2']?>;
    document.getElementById('perweight_22').value= <?= $row2['perweight_2']?>+<?= $row2_b['perweight_2']?>;
    document.getElementById('weight_22').value= <?= $kg2_2?>+<?=$kg2_2_b?>;
    document.getElementById('worktime_22').value= <?= $worktime_2_1?>+<?= $worktime_2_1_b?>;
    document.getElementById('stoptime_22').value= <?= $stop2?>+<?= $stop2_b?>;
    document.getElementById('stopsign_22').value= "<?= $row2['br_2']?>"+" "+"<?= $row2_b['br_2']?>";
    document.getElementById('badweight_22').value= <?= $row2['failure_2']?>+<?= $row2_b['failure_2']?>;
    document.getElementById('badsign_22').value= "<?= $row2['failurereason_2']?>"+" "+"<?= $row2_b['failurereason_2']?>";
    ...
    document.getElementById('standard_31').value= "<?= $row3['standard_1']?>";
    document.getElementById('amount_31').value= <?= $row3['amount_1']?>+<?= $row3_b['amount_1']?>;
    document.getElementById('perweight_31').value= <?= $row3['perweight_1']?>+<?= $row3_b['perweight_1']?>;
    document.getElementById('weight_31').value= <?= $kg3?>+<?=$kg3_b?>;
    document.getElementById('worktime_31').value= <?= $worktime_3_1?>+<?= $worktime_3_1_b?>;
    document.getElementById('stoptime_31').value= <?= $stop3?>+<?= $stop3_b?>;
    document.getElementById('stopsign_31').value= "<?= $row3['br_1']?>"+" "+"<?= $row3_b['br_1']?>";
    document.getElementById('badweight_31').value= <?= $row3['failure_1']?>+<?= $row3_b['failure_1']?>;
    document.getElementById('badsign_31').value= "<?= $row3['failurereason_1']?>"+" "+"<?= $row3_b['failurereason_1']?>";


    document.getElementById('standard_32').value= "<?= $row3['standard_2']?>";
    document.getElementById('amount_32').value= <?= $row3['amount_2']?>+<?= $row3_b['amount_2']?>;
    document.getElementById('perweight_32').value= <?= $row3['perweight_2']?>+<?= $row3_b['perweight_2']?>;
    document.getElementById('weight_32').value= <?= $kg3_2?>+<?=$kg3_2_b?>;
    document.getElementById('worktime_32').value= <?= $worktime_3_1?>+<?= $worktime_3_1_b?>;
    document.getElementById('stoptime_32').value= <?= $stop3?>+<?= $stop3_b?>;
    document.getElementById('stopsign_32').value= "<?= $row3['br_2']?>"+" "+"<?= $row3_b['br_2']?>";
    document.getElementById('badweight_32').value= <?= $row3['failure_2']?>+<?= $row3_b['failure_2']?>;
    document.getElementById('badsign_32').value= "<?= $row3['failurereason_2']?>"+" "+"<?= $row3_b['failurereason_2']?>";
    ...
    document.getElementById('standard_41').value= "<?= $row4['standard_1']?>";
    document.getElementById('amount_41').value= <?= $row4['amount_1']?>+<?= $row4_b['amount_1']?>;
    document.getElementById('perweight_41').value= <?= $row4['perweight_1']?>+<?= $row4_b['perweight_1']?>;
    document.getElementById('weight_41').value= <?= $kg4?>+<?=$kg4_b?>;
    document.getElementById('worktime_41').value= <?= $worktime_4_1?>+<?= $worktime_4_1_b?>;
    document.getElementById('stoptime_41').value= <?= $stop4?>+<?= $stop4_b?>;
    document.getElementById('stopsign_41').value= "<?= $row4['br_1']?>"+" "+"<?= $row4_b['br_1']?>";
    document.getElementById('badweight_41').value= <?= $row4['failure_1']?>+<?= $row4_b['failure_1']?>;
    document.getElementById('badsign_41').value= "<?= $row4['failurereason_1']?>"+" "+"<?= $row4_b['failurereason_1']?>";


    document.getElementById('standard_42').value= "<?= $row4['standard_2']?>";
    document.getElementById('amount_42').value= <?= $row4['amount_2']?>+<?= $row4_b['amount_2']?>;
    document.getElementById('perweight_42').value= <?= $row4['perweight_2']?>+<?= $row4_b['perweight_2']?>;
    document.getElementById('weight_42').value= <?= $kg4_2?>+<?=$kg4_2_b?>;
    document.getElementById('worktime_42').value= <?= $worktime_4_1?>+<?= $worktime_4_1_b?>;
    document.getElementById('stoptime_42').value= <?= $stop4?>+<?= $stop4_b?>;
    document.getElementById('stopsign_42').value= "<?= $row4['br_2']?>"+" "+"<?= $row4_b['br_2']?>";
    document.getElementById('badweight_42').value= <?= $row4['failure_2']?>+<?= $row4_b['failure_2']?>;
    document.getElementById('badsign_42').value= "<?= $row4['failurereason_2']?>"+" "+"<?= $row4_b['failurereason_2']?>";
    ...
    document.getElementById('standard_51').value= "<?= $row5['standard_1']?>";
    document.getElementById('amount_51').value= <?= $row5['amount_1']?>+<?= $row5_b['amount_1']?>;
    document.getElementById('perweight_51').value= <?= $row5['perweight_1']?>+<?= $row5_b['perweight_1']?>;
    document.getElementById('weight_51').value= <?= $kg5?>+<?=$kg5_b?>;
    document.getElementById('worktime_51').value= <?= $worktime_5_1?>+<?= $worktime_5_1_b?>;
    document.getElementById('stoptime_51').value= <?= $stop5?>+<?= $stop5_b?>;
    document.getElementById('stopsign_51').value= "<?= $row5['br_1']?>"+" "+"<?= $row5_b['br_1']?>";
    document.getElementById('badweight_51').value= <?= $row5['failure_1']?>+<?= $row5_b['failure_1']?>;
    document.getElementById('badsign_51').value= "<?= $row5['failurereason_1']?>"+" "+"<?= $row5_b['failurereason_1']?>";


    document.getElementById('standard_52').value= "<?= $row5['standard_2']?>";
    document.getElementById('amount_52').value= <?= $row5['amount_2']?>+<?= $row5_b['amount_2']?>;
    document.getElementById('perweight_52').value= <?= $row5['perweight_2']?>+<?= $row5_b['perweight_2']?>;
    document.getElementById('weight_52').value= <?= $kg5_2?>+<?=$kg5_2_b?>;
    document.getElementById('worktime_52').value= <?= $worktime_5_1?>+<?= $worktime_5_1_b?>;
    document.getElementById('stoptime_52').value= <?= $stop5?>+<?= $stop5_b?>;
    document.getElementById('stopsign_52').value= "<?= $row5['br_2']?>"+" "+"<?= $row5_b['br_2']?>";
    document.getElementById('badweight_52').value=  <?= $row5['failure_2']?>+<?= $row5_b['failure_2']?>;
    document.getElementById('badsign_52').value= "<?= $row5['failurereason_2']?>"+" "+"<?= $row5_b['failurereason_2']?>";


    document.getElementById('standard_53').value= "<?= $row5['standard_3']?>";
    document.getElementById('amount_53').value= <?= $row5['amount_3']?>+<?= $row5_b['amount_3']?>;
    document.getElementById('perweight_53').value= <?= $row5['perweight_3']?>+<?= $row5_b['perweight_3']?>;
    document.getElementById('weight_53').value= <?= $kg5_3?>+<?=$kg5_3_b?>;
    document.getElementById('worktime_53').value= <?= $worktime_5_1?>+<?= $worktime_5_1_b?>;
    document.getElementById('stoptime_53').value= <?= $stop5?>+<?= $stop5_b?>;
    document.getElementById('stopsign_53').value= "<?= $row5['br_3']?>"+" "+"<?= $row5_b['br_3']?>";
    document.getElementById('badweight_53').value= <?= $row5['failure_3']?>+<?= $row5_b['failure_3']?>;
    document.getElementById('badsign_53').value= "<?= $row5['failurereason_3']?>"+" "+"<?= $row5_b['failurereason_3']?>";




    document.getElementById('standard_61').value= "<?= $row6['standard_1']?>";
    document.getElementById('amount_61').value= <?= $row6['amount_1']?>+<?= $row6_b['amount_1']?>;
    document.getElementById('perweight_61').value= <?= $row6['perweight_1']?>+<?= $row6_b['perweight_1']?>;
    document.getElementById('weight_61').value= <?= $kg6?>+<?=$kg6_b?>;
    document.getElementById('worktime_61').value= <?= $worktime_6_1?>+<?= $worktime_6_1_b?>;
    document.getElementById('stoptime_61').value= <?= $stop6?>+<?= $stop6_b?>;
    document.getElementById('stopsign_61').value= "<?= $row6['br_1']?>"+" "+"<?= $row6_b['br_1']?>";
    document.getElementById('badweight_61').value= <?= $row6['failure_1']?>+<?= $row6_b['failure_1']?>;
    document.getElementById('badsign_61').value= "<?= $row6['failurereason_1']?>"+" "+"<?= $row6_b['failurereason_1']?>";


    document.getElementById('standard_62').value= "<?= $row6['standard_2']?>";
    document.getElementById('amount_62').value= <?= $row6['amount_2']?>+<?= $row6_b['amount_2']?>;
    document.getElementById('perweight_62').value= <?= $row6['perweight_2']?>+<?= $row6_b['perweight_2']?>;
    document.getElementById('weight_62').value= <?= $kg6_2?>+<?=$kg6_2_b?>;
    document.getElementById('worktime_62').value= <?= $worktime_6_1?>+<?= $worktime_6_1_b?>;
    document.getElementById('stoptime_62').value= <?= $stop6?>+<?= $stop6_b?>;
    document.getElementById('stopsign_62').value= "<?= $row6['br_2']?>"+" "+"<?= $row6_b['br_2']?>";
    document.getElementById('badweight_62').value= <?= $row6['failure_2']?>+<?= $row6_b['failure_2']?>;
    document.getElementById('badsign_62').value= "<?= $row6['failurereason_2']?>"+" "+"<?= $row6_b['failurereason_2']?>";


    document.getElementById('standard_71').value= "<?= $row7['standard_1']?>";
    document.getElementById('amount_71').value= <?= $row7['amount_1']?>+<?= $row7_b['amount_1']?>;
    document.getElementById('perweight_71').value= <?= $row7['perweight_1']?>+<?= $row7_b['perweight_1']?>;
    document.getElementById('weight_71').value= <?= $kg7?>+<?=$kg7_b?>;
    document.getElementById('worktime_71').value= <?= $worktime_7_1?>+<?= $worktime_7_1_b?>;
    document.getElementById('stoptime_71').value= <?= $stop7?>+<?= $stop7_b?>;
    document.getElementById('stopsign_71').value= "<?= $row7['br_1']?>"+" "+"<?= $row7_b['br_1']?>";
    document.getElementById('badweight_71').value= <?= $row7['failure_1']?>+<?= $row7_b['failure_1']?>;
    document.getElementById('badsign_71').value= "<?= $row7['failurereason_1']?>"+" "+"<?= $row7_b['failurereason_1']?>";


    document.getElementById('standard_72').value= "<?= $row7['standard_2']?>";
    document.getElementById('amount_72').value= <?= $row7['amount_2']?>+<?= $row7_b['amount_2']?>;
    document.getElementById('perweight_72').value= <?= $row7['perweight_2']?>+<?= $row7_b['perweight_2']?>;
    document.getElementById('weight_72').value= <?= $kg7_2?>+<?=$kg7_2_b?>;
    document.getElementById('worktime_72').value= <?= $worktime_7_1?>+<?= $worktime_7_1_b?>;
    document.getElementById('stoptime_72').value= <?= $stop7?>+<?= $stop7_b?>;
    document.getElementById('stopsign_72').value= "<?= $row7['br_2']?>"+" "+"<?= $row7_b['br_2']?>";
    document.getElementById('badweight_72').value= <?= $row7['failure_2']?>+<?= $row7_b['failure_2']?>;
    document.getElementById('badsign_72').value= "<?= $row7['failurereason_2']?>"+" "+"<?= $row7_b['failurereason_2']?>";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process1_count.php?date=' + value;
  ...
  <script type="text/javascript">
    function revisedb(){
      document.getElementById('writer1').disabled = false;
      document.getElementById('writer2').disabled = false;
      document.getElementById('writer3').disabled = false;
      document.getElementById('writer4').disabled = false;
      document.getElementById('writer5').disabled = false;
      document.getElementById('writer6').disabled = false;
      document.getElementById('writer7').disabled = false;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="bread">
          <a class="btn btn-outline-danger" href="process1_count_n.php">주간</a>
          <a class="btn btn-outline-dark" href="process1_count_b.php">야간</a>
          <a class="btn btn-outline-success" href="process1_count_1.php">수량종합</a>
        ...
        <form method='post' action='revise_process1_count.php'>
          <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead>
                ...
                <tr>
                  <th colspan="14">주간근무자</th>
                </tr>
                <tr>
                  <th>1</th>
                  <td><input type="text" name="writer1" id="writer1" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                  <th>2</th>
                  <td><input type="text" name="writer2" id="writer2" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                  <th>3</th>
                  <td><input type="text" name="writer3" id="writer3" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                  <th>4</th>
                  <td><input type="text" name="writer4" id="writer4" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                  <th>5</th>
                  <td><input type="text" name="writer5" id="writer5" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                  <th>6</th>
                  <td><input type="text" name="writer6" id="writer6" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                  <th>7</th>
                  <td><input type="text" name="writer7" id="writer7" class="form-control" disabled='disabled' placeholder="작성자" /></td>
                </tr>
                <tr>
