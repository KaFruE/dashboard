...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from expandhogi03_work where date='$dt' AND  checktime_1  NOT BETWEEN '06:00:01' AND '18:00:00'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './expand_process3_work_2.php?date=' + value;
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">
            <a href="expand_process3.php">제 확관 3 호기</a>
          </li>
          <li class="breadcrumb-item active">
            <a href="expand_process3_work">작업일지</a>
          </li>
        ...
        <!-- Page Content -->
        <form method='post' action='revise_expand_process3_work_2.php'>
