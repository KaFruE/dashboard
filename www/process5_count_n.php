...
<head>
  ...
  $(document).ready(function() {
    ...
    document.getElementById('amount_11').value= "<?= $row1['amount_1']?>";
    document.getElementById('perweight_11').value= "<?= $row1['perweight_1']?>";
    document.getElementById('weight_11').value= <?= $kg1?>;
    document.getElementById('worktime_11').value= <?= $worktime_1_1?>;
    document.getElementById('stoptime_11').value= <?= $stop1?>;
    document.getElementById('stopsign_11').value= "<?= $row1['br_1']?>";
    document.getElementById('badweight_11').value= "<?= $row1['failure_1']?>";
    document.getElementById('badsign_11').value= "<?= $row1['failurereason_1']?>";


    document.getElementById('standard_12').value= "<?= $row1['standard_2']?>";
    document.getElementById('amount_12').value= "<?= $row1['amount_2']?>";
    document.getElementById('perweight_12').value= "<?= $row1['perweight_2']?>";
    document.getElementById('weight_12').value= <?= $kg1_2?>;
    document.getElementById('worktime_12').value= <?= $worktime_1_1?>;
    document.getElementById('stoptime_12').value= <?= $stop1?>;
    document.getElementById('stopsign_12').value= "<?= $row1['br_2']?>";
    document.getElementById('badweight_12').value= "<?= $row1['failure_2']?>";
    document.getElementById('badsign_12').value= "<?= $row1['failurereason_2']?>";


    document.getElementById('standard_13').value= "<?= $row1['standard_3']?>";
    document.getElementById('amount_13').value= "<?= $row1['amount_3']?>";
    document.getElementById('perweight_13').value= "<?= $row1['perweight_3']?>";
    document.getElementById('weight_13').value= <?= $kg1_3?>;
    document.getElementById('worktime_13').value= <?= $worktime_1_1?>;
    document.getElementById('stoptime_13').value= <?= $stop1?>;
    document.getElementById('stopsign_13').value= "<?= $row1['br_3']?>";
    document.getElementById('badweight_13').value= "<?= $row1['failure_3']?>";
    document.getElementById('badsign_13').value= "<?= $row1['failurereason_3']?>";
    ...
    document.getElementById('amount_21').value= "<?= $row2['amount_1']?>";
    document.getElementById('perweight_21').value= "<?= $row2['perweight_1']?>";
    document.getElementById('weight_21').value= <?= $kg2?>;
    document.getElementById('worktime_21').value= <?= $worktime_2_1?>;
    document.getElementById('stoptime_21').value= <?= $stop2?>;
    document.getElementById('stopsign_21').value= "<?= $row2['br_1']?>";
    document.getElementById('badweight_21').value= "<?= $row2['failure_1']?>";
    document.getElementById('badsign_21').value= "<?= $row2['failurereason_1']?>";


    document.getElementById('standard_22').value= "<?= $row2['standard_2']?>";
    document.getElementById('amount_22').value= "<?= $row2['amount_2']?>";
    document.getElementById('perweight_22').value= "<?= $row2['perweight_2']?>";
    document.getElementById('weight_22').value= <?= $kg2_2?>;
    document.getElementById('worktime_22').value= <?= $worktime_2_1?>;
    document.getElementById('stoptime_22').value= <?= $stop2?>;
    document.getElementById('stopsign_22').value= "<?= $row2['br_2']?>";
    document.getElementById('badweight_22').value= "<?= $row2['failure_2']?>";
    document.getElementById('badsign_22').value= "<?= $row2['failurereason_2']?>";
    ...
    document.getElementById('amount_31').value= "<?= $row3['amount_1']?>";
    document.getElementById('perweight_31').value= "<?= $row3['perweight_1']?>";
    document.getElementById('weight_31').value= <?= $kg3?>;
    document.getElementById('worktime_31').value= <?= $worktime_3_1?>;
    document.getElementById('stoptime_31').value= <?= $stop3?>;
    document.getElementById('stopsign_31').value= "<?= $row3['br_1']?>";
    document.getElementById('badweight_31').value= "<?= $row3['failure_1']?>";
    document.getElementById('badsign_31').value= "<?= $row3['failurereason_1']?>";


    document.getElementById('standard_32').value= "<?= $row3['standard_2']?>";
    document.getElementById('amount_32').value= "<?= $row3['amount_2']?>";
    document.getElementById('perweight_32').value= "<?= $row3['perweight_2']?>";
    document.getElementById('weight_32').value= <?= $kg3_2?>;
    document.getElementById('worktime_32').value= <?= $worktime_3_1?>;
    document.getElementById('stoptime_32').value= <?= $stop3?>;
    document.getElementById('stopsign_32').value= "<?= $row3['br_2']?>";
    document.getElementById('badweight_32').value= "<?= $row3['failure_2']?>";
    document.getElementById('badsign_32').value= "<?= $row3['failurereason_2']?>";
    ...
    document.getElementById('amount_41').value= "<?= $row4['amount_1']?>";
    document.getElementById('perweight_41').value= "<?= $row4['perweight_1']?>";
    document.getElementById('weight_41').value= <?= $kg4?>;
    document.getElementById('worktime_41').value= <?= $worktime_4_1?>;
    document.getElementById('stoptime_41').value= <?= $stop4?>;
    document.getElementById('stopsign_41').value= "<?= $row4['br_1']?>";
    document.getElementById('badweight_41').value= "<?= $row4['failure_1']?>";
    document.getElementById('badsign_41').value= "<?= $row4['failurereason_1']?>";


    document.getElementById('standard_42').value= "<?= $row4['standard_2']?>";
    document.getElementById('amount_42').value= "<?= $row4['amount_2']?>";
    document.getElementById('perweight_42').value= "<?= $row4['perweight_2']?>";
    document.getElementById('weight_42').value= <?= $kg4_2?>;
    document.getElementById('worktime_42').value= <?= $worktime_4_1?>;
    document.getElementById('stoptime_42').value= <?= $stop4?>;
    document.getElementById('stopsign_42').value= "<?= $row4['br_2']?>";
    document.getElementById('badweight_42').value= "<?= $row4['failure_2']?>";
    document.getElementById('badsign_42').value= "<?= $row4['failurereason_2']?>";
    ...
    document.getElementById('amount_51').value= "<?= $row5['amount_1']?>";
    document.getElementById('perweight_51').value= "<?= $row5['perweight_1']?>";
    document.getElementById('weight_51').value= <?= $kg5?>;
    document.getElementById('worktime_51').value= <?= $worktime_5_1?>;
    document.getElementById('stoptime_51').value= <?= $stop5?>;
    document.getElementById('stopsign_51').value= "<?= $row5['br_1']?>";
    document.getElementById('badweight_51').value= "<?= $row5['failure_1']?>";
    document.getElementById('badsign_51').value= "<?= $row5['failurereason_1']?>";


    document.getElementById('standard_52').value= "<?= $row5['standard_2']?>";
    document.getElementById('amount_52').value= "<?= $row5['amount_2']?>";
    document.getElementById('perweight_52').value= "<?= $row5['perweight_2']?>";
    document.getElementById('weight_52').value= <?= $kg5_2?>;
    document.getElementById('worktime_52').value= <?= $worktime_5_1?>;
    document.getElementById('stoptime_52').value= <?= $stop5?>;
    document.getElementById('stopsign_52').value= "<?= $row5['br_2']?>";
    document.getElementById('badweight_52').value= "<?= $row5['failure_2']?>";
    document.getElementById('badsign_52').value= "<?= $row5['failurereason_2']?>";


    document.getElementById('standard_53').value= "<?= $row5['standard_3']?>";
    document.getElementById('amount_53').value= "<?= $row5['amount_3']?>";
    document.getElementById('perweight_53').value= "<?= $row5['perweight_3']?>";
    document.getElementById('weight_53').value= <?= $kg5_3?>;
    document.getElementById('worktime_53').value= <?= $worktime_5_1?>;
    document.getElementById('stoptime_53').value= <?= $stop5?>;
    document.getElementById('stopsign_53').value= "<?= $row5['br_3']?>";
    document.getElementById('badweight_53').value= "<?= $row5['failure_3']?>";
    document.getElementById('badsign_53').value= "<?= $row5['failurereason_3']?>";




    document.getElementById('standard_61').value= "<?= $row6['standard_1']?>";
    document.getElementById('amount_61').value= "<?= $row6['amount_1']?>";
    document.getElementById('perweight_61').value= "<?= $row6['perweight_1']?>";
    document.getElementById('weight_61').value= <?= $kg6?>;
    document.getElementById('worktime_61').value= <?= $worktime_6_1?>;
    document.getElementById('stoptime_61').value= <?= $stop6?>;
    document.getElementById('stopsign_61').value= "<?= $row6['br_1']?>";
    document.getElementById('badweight_61').value= "<?= $row6['failure_1']?>";
    document.getElementById('badsign_61').value= "<?= $row6['failurereason_1']?>";


    document.getElementById('standard_62').value= "<?= $row6['standard_2']?>";
    document.getElementById('amount_62').value= "<?= $row6['amount_2']?>";
    document.getElementById('perweight_62').value= "<?= $row6['perweight_2']?>";
    document.getElementById('weight_62').value= <?= $kg6_2?>;
    document.getElementById('worktime_62').value= <?= $worktime_6_1?>;
    document.getElementById('stoptime_62').value= <?= $stop6?>;
    document.getElementById('stopsign_62').value= "<?= $row6['br_2']?>";
    document.getElementById('badweight_62').value= "<?= $row6['failure_2']?>";
    document.getElementById('badsign_62').value= "<?= $row6['failurereason_2']?>";


    document.getElementById('standard_71').value= "<?= $row7['standard_1']?>";
    document.getElementById('amount_71').value= "<?= $row7['amount_1']?>";
    document.getElementById('perweight_71').value= "<?= $row7['perweight_1']?>";
    document.getElementById('weight_71').value= <?= $kg7?>;
    document.getElementById('worktime_71').value= <?= $worktime_7_1?>;
    document.getElementById('stoptime_71').value= <?= $stop7?>;
    document.getElementById('stopsign_71').value= "<?= $row7['br_1']?>";
    document.getElementById('badweight_71').value= "<?= $row7['failure_1']?>";
    document.getElementById('badsign_71').value= "<?= $row7['failurereason_1']?>";


    document.getElementById('standard_72').value= "<?= $row7['standard_2']?>";
    document.getElementById('amount_72').value= "<?= $row7['amount_2']?>";
    document.getElementById('perweight_72').value= "<?= $row7['perweight_2']?>";
    document.getElementById('weight_72').value= <?= $kg7_2?>;
    document.getElementById('worktime_72').value= <?= $worktime_7_1?>;
    document.getElementById('stoptime_72').value= <?= $stop7?>;
    document.getElementById('stopsign_72').value= "<?= $row7['br_2']?>";
    document.getElementById('badweight_72').value= "<?= $row7['failure_2']?>";
    document.getElementById('badsign_72').value= "<?= $row7['failurereason_2']?>";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process1_count_n.php?date=' + value;
