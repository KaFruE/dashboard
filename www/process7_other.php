...
<head>
  ...
  $(document).ready(function() {
    <?php
        ...
        $query = "select * from hogi07_other where date='$dt'";
  ...
  function input_Text()
  {
    ...
    window.location.href = './process7_other.php?date=' + value;
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <!-- Page Content -->
        <form method='post' action='revise_process7_other.php'>
