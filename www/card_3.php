...
<head>
  ...
  $(document).ready(function(){
     <?php
         ...
         $rows_1_3 = array();
         while($row_1_3=mysqli_fetch_array($result1_3)) {
           $rows_1_3[] = $row_1_3;
         };
         $rows_2_3 = array();
         while($row_2_2=mysqli_fetch_array($result2_3)) {
           $rows_2_3[] = $row_2_3;
         };
  ...
  <script>
      ...
      foreach($rows_1_3 as $value1_3) {
        ?>
        myArray1_1[i] = "<?=$value1_3['num']?>";
        myArray1_2[i] = "<?=$value1_3['product']?>";
        myArray1_3[i] = "<?=$value1_3['date']?>";
        myArray1_4[i] = "<?=$value1_3['writer']?>";
        myArray1_5[i] = "<?=$value1_3['input_time']?>";
        myArray1_6[i] = "<?=$value1_3['c1']?>";
        myArray1_7[i] = "<?=$value1_3['c2']?>";
        myArray1_8[i] = "<?=$value1_3['c3']?>";
        myArray1_9[i] = "<?=$value1_3['c4']?>";
        myArray1_10[i] = "<?=$value1_3['c5']?>";
        myArray1_11[i] = "<?=$value1_3['c6']?>";
        myArray1_12[i] = "<?=$value1_3['c7']?>";
        myArray1_13[i] = "<?=$value1_3['c8']?>";
        myArray1_14[i] = "<?=$value1_3['H']?>";
        myArray1_15[i] = "<?=$value1_3['d1']?>";
        myArray1_16[i] = "<?=$value1_3['d3']?>";
        myArray1_17[i] = "<?=$value1_3['d4']?>";
        myArray1_18[i] = "<?=$value1_3['d5']?>";
        myArray1_19[i] = "<?=$value1_3['d6']?>";
        myArray1_20[i] = "<?=$value1_3['nop']?>";
        myArray1_21[i] = "<?=$value1_3['jm']?>";
        myArray1_22[i] = "<?=$value1_3['jingon']?>";
        myArray1_23[i] = "<?=$value1_3['hdmoter']?>";
        myArray1_24[i] = "<?=$value1_3['mainmoter']?>";
        myArray1_25[i] = "<?=$value1_3['mainrpm']?>";
        myArray1_26[i] = "<?=$value1_3['screw']?>";
        myArray1_27[i] = "<?=$value1_3['icetem']?>";
        myArray1_28[i] = "<?=$value1_3['corogate']?>";
        myArray1_29[i] = "<?=$value1_3['length']?>";
   ...
   <script>
        ...
        <?php
        foreach($rows_2_3 as $value2_3) {
          ?>
          myArray2_1[i2] = "<?=$value2_3['product']?>";
          myArray2_2[i2] = "<?=$value2_3['date']?>";
          myArray2_3[i2] = "<?=$value2_3['writer']?>";
          myArray2_4[i2] = "<?=$value2_3['input_time']?>";
          myArray2_5[i2] = "<?=$value2_3['appearance']?>";
          myArray2_6[i2] = "<?=$value2_3['color']?>";
          myArray2_7[i2] = "<?=$value2_3['diameter']?>";
          myArray2_8[i2] = "<?=$value2_3['out_max']?>";
          myArray2_9[i2] = "<?=$value2_3['out_min']?>";
          myArray2_10[i2] = "<?=$value2_3['in_max']?>";
          myArray2_11[i2] = "<?=$value2_3['in_min']?>";
          myArray2_12[i2] = "<?=$value2_3['gol_max']?>";
          myArray2_13[i2] = "<?=$value2_3['gol_min']?>";
          myArray2_14[i2] = "<?=$value2_3['display']?>";
          myArray2_15[i2] = "<?=$value2_3['length']?>";
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">3호기 데이터베이스</li>
        </ol>
        ...
        <div class="row">
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-danger mb-3 h-100">
              <div class="card-header">당일 3호기 압출 데이터 수</div>
                <div class="card-body text-danger">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">3호기 압출의 데이터 수</h5>
                  <div class="mr-5"><?=$row11_3?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-warning mb-3 h-100">
              <div class="card-header">당일 3호기 절단 데이터 수</div>
                <div class="card-body text-warning">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">3호기 절단의 데이터 수</h5>
                  <div class="mr-5"><?=$row12_3?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-success mb-3 h-100">
              <div class="card-header">당일 3호기 수량 데이터 수</div>
                <div class="card-body text-success">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">3호기 수량의 데이터 수</h5>
                  <div class="mr-5"><?= $row13_3?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-info mb-3 success h-100">
              <div class="card-header">당일 3호기 배합 데이터 수</div>
                <div class="card-body text-info">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title"> 3호기 배합의 데이터 수</h5>
                  <div class="mr-5"><?= $row15_3?> 개</div>
                </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-sm-6 mb-3">
            <div class="card border-primary mb-3 h-100">
              <div class="card-header">당일 3호기 기타 데이터 수</div>
                <div class="card-body text-primary">
                  <div class="card-body-icon">
                  </div>
                  <h5 class="card-title">3호기 기타의 데이터 수</h5>
                  <div class="mr-5"><?= $row14_3?> 개</div>
                </div>
            </div>
          </div>
