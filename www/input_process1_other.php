...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <form method='post' action='write_process1_other.php'>
          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            <thead>
              <tr>
                ...
                <th>잠깐정지시간</th>
                <td><input type="number" name="awhilestop_1" id="awhilestop_1" class="form-control" placeholder="시 간" /></td>
                <th>잠깐정지시간</th>
                <td><input type="number" name="awhilestop_2" id="awhilestop_2" class="form-control" placeholder="시 간" /></td>
              </tr>
            </thead>
          </table>
        </div>
